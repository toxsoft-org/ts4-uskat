...
public interface ISkRefbookServiceValidator {
   ...
   */
  ValidationResult canDefineRefbook( IDtoObject aDpuRefbookInfo, ISkRefbook aExistingRefbook );
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  ValidationResult canDefineItem( ISkRefbook aRefbook, IDtoFullObject aNewItem, IStringMap<ISkidList> aLinks,
      ISkRefbookItem aOldItem );
