...
/**
 * Расширение бекенда для службы {@link ISkAlarmService}.
 *
 * @author mvk
 */
public interface ISkBackendAddonAlarm {

  /**
   * Идентификатор модуля реализующего бекенд
   */
  String S5_BACKEND_ALARMS_ID = ISkBackendAddonAlarm.class.getName();

  /**
   * Имя модуля реализующего бекенд
   */
  String S5_BACKEND_ALARMS_NAME = STR_N_BACKEND_ALARMS;
