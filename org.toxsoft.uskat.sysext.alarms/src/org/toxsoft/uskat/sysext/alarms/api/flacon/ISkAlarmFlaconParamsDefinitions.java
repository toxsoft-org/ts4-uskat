package org.toxsoft.uskat.sysext.alarms.api.flacon;
...
/**
 * Описание параметров флакона - наименование, тип и т.д.
 *
 * @author dima
 */
@SuppressWarnings( "nls" )
public interface ISkAlarmFlaconParamsDefinitions {
   ...
   */
  IDataDef FLACON_MSG = create( "FlaconMsg", EAtomicType.STRING, TSID_NAME, "SkAlarmFlacon message", //
      TSID_DESCRIPTION, "SkAlarmFlacon message", //
      TSID_IS_NULL_ALLOWED, AV_FALSE, //
      TSID_DEFAULT_VALUE, AvUtils.avStr( "SkAlarmFlacon message" ) );
