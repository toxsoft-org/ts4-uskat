...
import static org.toxsoft.uskat.sysext.realtime.supports.commands.IS5Resources.*;
...
import ru.uskat.core.api.sysdescr.ISkCmdInfo;
...
public interface IS5CommandHardConstants
  ...
  /**
   * Опция {@link ISkCmdInfo#params()}: время ожидания завершения выполнения команды (мсек).
   * <p>
  ...
  /**
   * Опция {@link ISkCmdInfo#params()}: полное имя java-класса реализации блока.
   * <p>
  ...
  /**
   * Опция {@link ISkCmdInfo#params()}: полное имя java-класса реализации blob значений.
   * <p>
   * Тип: {@link EAtomicType#STRING}
   */
  ...
  /**
   * Опция {@link ISkCmdInfo#params()}: количество значений в одном блоке.
   * <p>
   * Тип: {@link EAtomicType#INTEGER}
   */
  ...
  /**
   * Опция {@link ISkCmdInfo#params()}: максимальный размер одного значения (байты).
   * <p>
   * Тип: {@link EAtomicType#INTEGER}
   * <p>
