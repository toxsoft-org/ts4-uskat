 ...
 */
@Entity
public class S5HistDataAsyncStringEntity
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity> {
   ...
   * @return {@link S5HistDataAsyncStringEntity} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity blob = new S5HistDataAsyncStringBlobEntity( timestamps, values );
    return new S5HistDataAsyncStringEntity( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity} реализация blob-а в котором хранятся значения блока и их метки
   *          времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity blob = new S5HistDataAsyncStringBlobEntity( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity( aResultSet );
  }
