...
interface ISkResources {
  ...
  String STR_IS_EVENTS_STORED           = Messages.getString( "STR_IS_EVENTS_STORED" );           //$NON-NLS-1$
  String STR_IS_EVENTS_STORED_D         = Messages.getString( "STR_IS_EVENTS_STORED_D" );         //$NON-NLS-1$
  String STR_MAX_EVENTS_COUNT           = Messages.getString( "STR_MAX_EVENTS_COUNT" );           //$NON-NLS-1$
  String STR_MAX_EVENTS_COUNT_D         = Messages.getString( "STR_MAX_EVENTS_COUNT_D" );         //$NON-NLS-1$
  String STR_IS_CMDS_STORED             = Messages.getString( "STR_IS_CMDS_STORED" );             //$NON-NLS-1$
  String STR_IS_CMDS_STORED_D           = Messages.getString( "STR_IS_CMDS_STORED_D" );           //$NON-NLS-1$
  String STR_MAX_CMDS_COUNT             = Messages.getString( "STR_MAX_CMDS_COUNT" );             //$NON-NLS-1$
  String STR_MAX_CMDS_COUNT_D           = Messages.getString( "STR_MAX_CMDS_COUNT_D" );           //$NON-NLS-1$
  String STR_HISTORY_DEPTH_HOURS        = Messages.getString( "STR_HISTORY_DEPTH_HOURS" );        //$NON-NLS-1$
  String STR_HISTORY_DEPTH_HOURS_D      = Messages.getString( "STR_HISTORY_DEPTH_HOURS_D" );      //$NON-NLS-1$
  String STR_CURR_DATA_10MS_TICKS       = Messages.getString( "STR_CURR_DATA_10MS_TICKS" );       //$NON-NLS-1$
  String STR_CURR_DATA_10MS_TICKS_D     = Messages.getString( "STR_CURR_DATA_10MS_TICKS_D" );     //$NON-NLS-1$
