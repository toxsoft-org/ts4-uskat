 ...
 * @author dima
 */
public class SingleSkidUgwiSelectPanel2
   ...
   */
  public SingleSkidUgwiSelectPanel2( ITsGuiContext aContext, boolean aIsViewer ) {
  ...
  public Ugwi selectedItem() {
    ...
    ISkObject selObj = panelObjects.selectedItem();
    return UgwiKindSkSkid.makeUgwi( selObj.skid() );
  }
  ...
  public static Ugwi selectUgwi( ITsDialogInfo aDialogInfo, Ugwi aInitVal, IdChain aSkConnKey ) {
    ...
    -> new TsDialogGenericEntityEditPanel<>( par, od, ( aContext, aViewer ) -> {
      SingleSkidUgwiSelectPanel2 panel = new SingleSkidUgwiSelectPanel2( aContext, aViewer );
      return panel;
    } );
