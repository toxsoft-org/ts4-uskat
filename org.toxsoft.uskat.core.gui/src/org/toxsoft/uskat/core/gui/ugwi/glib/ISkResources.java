...
interface ISkResources {
  ...
  /**
   * {@link PanelSingleConcreteGwidSelector}
   */
  ...
  /**
   * {@link ValedSingleConcreteGwidSelector}
   */
  String MSG_ERR_INV_GWID_FORMAT = Messages.getString( "MSG_ERR_INV_GWID_FORMAT" ); //$NON-NLS-1$
  String MSG_ERR_INV_GWID_KIND   = Messages.getString( "MSG_ERR_INV_GWID_KIND" );   //$NON-NLS-1$
