...
public interface ISkCoreGuiConstants {
  ...
  String ICONID_SDED_CLASS_ATTR     = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_ATTR;
  String ICONID_SDED_CLASS_CLOB     = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_CLOB;
  String ICONID_SDED_CLASS_RIVET    = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_RIVET;
  String ICONID_SDED_CLASS_LINK     = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_LINK;
  String ICONID_SDED_CLASS_DATA     = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_DATA;
  String ICONID_SDED_CLASS_CMD      = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_CMD;
  String ICONID_SDED_CLASS_EVENT    = ISkCoreGuiInnerSharedConstants.ICONID_SDED_CLASS_EVENT;
  String ICONID_SDED_OBJ            = "sded-obj";                                            //$NON-NLS-1$
  String ICONID_SDED_OBJS_LIST      = "sded-objs-list";                                      //$NON-NLS-1$
  String ICONID_SDED_OBJ_ATTR       = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_ATTR;
  String ICONID_SDED_OBJ_CLOB       = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_CLOB;
  String ICONID_SDED_OBJ_RIVET      = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_CMD;
  String ICONID_SDED_OBJ_LINK       = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_LINK;
  String ICONID_SDED_OBJ_DATA       = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_DATA;
  String ICONID_SDED_OBJ_CMD        = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_CMD;
  String ICONID_SDED_OBJ_EVENT      = ISkCoreGuiInnerSharedConstants.ICONID_SDED_OBJ_EVENT;
