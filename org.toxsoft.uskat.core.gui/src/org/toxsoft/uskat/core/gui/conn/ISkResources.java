...
interface ISkResources {
   ...
   */
  String FMT_ERR_NO_SUCH_CONN_ID     = Messages.getString( "FMT_ERR_NO_SUCH_CONN_ID" );     //$NON-NLS-1$
  String FMT_WARN_ALREADY_DEF_CONN   = Messages.getString( "FMT_WARN_ALREADY_DEF_CONN" );   //$NON-NLS-1$
