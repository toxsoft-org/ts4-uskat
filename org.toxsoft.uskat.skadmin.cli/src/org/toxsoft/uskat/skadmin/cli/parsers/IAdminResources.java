...
interface IAdminResources {
  ...
  String ERR_MSG_ARG_FLAG_INPOSSIBLE = "В текущем наборе значений аргументов использование флага '%s' недопустимо.";
  ...
  String ERR_MSG_INVALID_QUOTED = "Неверный формат строкового значения %s. Значение должно быть указано в кавычках.";
  ...
  String MSG_ERR_READ_SUPER_QUOTE = "Ошибка чтения супер кавычек %s. Вместо символа ('%c') ожидались символ ('%c')";
