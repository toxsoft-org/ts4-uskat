 ...
 * @author mvk
 */
public final class S5CallbackOnBackendMessage
    implements IJSONNotificationHandler<S5CallbackChannel> {

  /**
   * Вызов метода: {@link ISkFrontendRear#onBackendMessage(GtMessage)}
   */
  public static final String ON_MESSAGE_METHOD = BACKEND_METHOD_PREFIX + "onBackendMessage"; //$NON-NLS-1$
   ...
   */
  S5CallbackOnBackendMessage( ISkFrontendRear aFrontend ) {
