...
import org.toxsoft.uskat.s5.server.backend.addons.realtime.*;
import org.toxsoft.uskat.s5.server.backend.addons.realtime.pas.S5RealtimeCallbackWriteCurrData;
import org.toxsoft.uskat.s5.server.backend.addons.realtime.pas.S5RealtimeCallbackWriteHistData;
import org.toxsoft.uskat.s5.server.backend.supports.histdata.IS5HistDataSequenceWriter;
import org.toxsoft.uskat.s5.server.backend.supports.histdata.sequences.S5HistDataWriteSupport;
...
public final class S5RealtimeRemote
  ...
  private final S5EventSupport         eventSupport;
  ...
  public S5RealtimeRemote( ITsContextRo aArgs ) {
    ...
    eventSupport = new S5EventSupport();
  ...
  public void setNeededEventGwids( IGwidList aNeededGwids ) {
    ...
    if( remote != null ) {
      remote.setNeededEventGwids( aNeededGwids );
    }
  }
  ...
  protected void doOnAfterDiscover( IS5Connection aSource ) {
    ...
    initData.eventGwids.setAll( eventSupport.gwids() );
