...
/**
 * Бинарный индекс произвольного значения по длинному целочисленному ключу
 *
 * @author mvk
 * @param <V> тип значений
 */
class S5LongElemIndexImpl<V>
    extends S5AbstractIndex<Long, V>
    implements ILongElemIndexEdit<V> {
   ...
   */
  S5LongElemIndexImpl( boolean aUnique, long[] aKeys, V[] aValues, boolean aRestore ) {
  ...
  @Override
  public void add( ILongList aKeys, IList<V> aValues ) {
    TsNullArgumentRtException.checkNulls( aKeys, aValues );
  ...
  @Override
  public void add( long[] aKeys, V[] aValues ) {
    TsNullArgumentRtException.checkNulls( aKeys, aValues );
    checkSize( aKeys.length, aValues.length );
  ...
  public void add( Long aKey, V aValue ) {
    ...
    add( aKey.longValue(), aValue );
  }

  @Override
  public int add( long aKey, V aValue ) {
  ...
  @Override
  public V findValue( Long aKey ) {
    return findValue( aKey.longValue() );
  }
  ...
  @Override
  public V getValue( Long aKey ) {
    return getValue( aKey.longValue() );
  }
