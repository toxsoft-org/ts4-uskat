...
import org.toxsoft.uskat.s5.utils.indexes.ILongLongIndexEdit;

/**
 * Бинарный индекс длинного целочисленного значения по длинному целочисленному ключу
 *
 * @author mvk
 */
class S5LongLongIndexImpl
    extends S5AbstractIndex<Long, Long>
    implements ILongLongIndexEdit {
   ...
   */
  S5LongLongIndexImpl( boolean aUnique, long[] aKeys, long[] aValues, boolean aRestore ) {
  ...
  @Override
  public void add( ILongList aKeys, ILongList aValues ) {
    TsNullArgumentRtException.checkNulls( aKeys, aValues );
  ...
  @Override
  public void add( long[] aKeys, long[] aValues ) {
    TsNullArgumentRtException.checkNulls( aKeys, aValues );
    checkSize( aKeys.length, aValues.length );
  ...
  @Override
  public void add( Long aKey, Long aValue ) {
  ...
  @Override
  public Long findValue( Long aKey ) {
    return Long.valueOf( findValue( aKey.longValue() ) );
  }
  ...
  public Long getValue( Long aKey ) {
    return Long.valueOf( getValue( aKey.longValue() ) );
  }
