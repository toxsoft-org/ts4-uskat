...
public interface IS5SessionInitData {
  ...
  /**
   * Возвращает список идентификаторов расширений бекенда поддерживаемых клиентом.
   *
   * @return {@link IStringList} список идентификаторов расширений бекенда {@link IBackendAddon#id()}.
   */
  IStringList baIds();
   ...
   * @return {@link IS5BackendAddonData} данные расширения. null: у расширения нет данных.
