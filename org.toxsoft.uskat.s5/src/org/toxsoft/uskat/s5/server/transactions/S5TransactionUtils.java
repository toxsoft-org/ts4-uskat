...
public class S5TransactionUtils {
   ...
   * @return {@link IList}&lt;{@link IDtoObject}&lt; список объектов изменяющегося класса или его наследников
   * @throws TsNullArgumentRtException любой аргумент = null
   */
  public static IList<IDtoObject> txRemovedClassObjs( IS5TransactionManagerSingleton aTransactionManager,
    ...
    IList<IDtoObject> retValue = tx.findResource( TX_REMOVED_CLASS_OBJS );
    if( retValue != null ) {
   ...
   * @param aDescendants {@link IStridablesList}&lt;{@link IDtoClassInfo}&gt; список описаний классов наследников
   * @return {@link IList}&lt;{@link IDtoObject}&lt; список объектов изменяющегося класса или его наследников
   * @throws TsNullArgumentRtException любой аргумент = null
   */
  public static IList<IDtoObject> txUpdatedClassObjs( IS5TransactionManagerSingleton aTransactionManager,
      IS5BackendObjectsSingleton aObjectsBackend, String aParentClassId, IStridablesList<IDtoClassInfo> aDescendants ) {
    TsNullArgumentRtException.checkNulls( aTransactionManager, aObjectsBackend, aParentClassId, aDescendants );
    // Текущая транзакция
    IS5Transaction tx = aTransactionManager.getTransaction();
    // Поиск ресурса в транзакции
    IList<IDtoObject> retValue = tx.findResource( TX_UPDATED_CLASS_OBJS );
    if( retValue != null ) {
      // Ресурс найден в транзакции
      return retValue;
    }
