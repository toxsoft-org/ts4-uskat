 ...
 * сохранения объектов по умолчанию
 *
 * @author mvk
 */
@Entity
public final class S5DefaultObjectEntity
   ...
   */
  S5DefaultObjectEntity( IDtoObject aSource ) {
    super( aSource );
  }
   ...
   */
  S5DefaultObjectEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
   ...
   * @throws TsNullArgumentRtException аргумент = null
   */
  S5DefaultObjectEntity( S5ObjectID aId ) {
    super( aId );
  }
   ...
   * @return {@link S5DefaultObjectEntity} PRIMARY-ключ
   * @throws TsNullArgumentRtException аргумент = null
   */
  public static S5DefaultObjectEntity createPrimaryKey( Skid aSkid ) {
    TsNullArgumentRtException.checkNull( aSkid );
    return new S5DefaultObjectEntity( new S5ObjectID( aSkid ) );
  }
}
