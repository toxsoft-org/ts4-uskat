 ...
 */
@Entity
public class S5HistDataSyncStringEntity
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity> {
   ...
   * @return {@link S5HistDataSyncStringEntity} блок значений
   ...
   */
  static S5HistDataSyncStringEntity create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity blob = new S5HistDataSyncStringBlobEntity( values );
    return new S5HistDataSyncStringEntity( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncStringBlobEntity blob = new S5HistDataSyncStringBlobEntity( aValues );
    return new S5HistDataSyncStringEntity( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity( aResultSet );
  }
