 ...
 */
@Entity
public class S5HistDataSyncValobjEntity
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity> {
   ...
   * @return {@link S5HistDataSyncValobjEntity} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity blob = new S5HistDataSyncValobjBlobEntity( values );
    return new S5HistDataSyncValobjEntity( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncValobjBlobEntity blob = new S5HistDataSyncValobjBlobEntity( aValues );
    return new S5HistDataSyncValobjEntity( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity( aResultSet );
  }
