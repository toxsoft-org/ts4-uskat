...
public class S5HistDataAsyncBooleanBlobEntity
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
