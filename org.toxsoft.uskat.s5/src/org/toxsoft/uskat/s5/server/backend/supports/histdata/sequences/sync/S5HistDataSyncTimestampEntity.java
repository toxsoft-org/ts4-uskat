 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity blob = new S5HistDataSyncTimestampBlobEntity( values );
    return new S5HistDataSyncTimestampEntity( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncTimestampBlobEntity blob = new S5HistDataSyncTimestampBlobEntity( aValues );
    return new S5HistDataSyncTimestampEntity( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity( aResultSet );
  }
