 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity blob = new S5HistDataAsyncTimestampBlobEntity( timestamps, values );
    return new S5HistDataAsyncTimestampEntity( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity blob = new S5HistDataAsyncTimestampBlobEntity( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity( aResultSet );
  }
