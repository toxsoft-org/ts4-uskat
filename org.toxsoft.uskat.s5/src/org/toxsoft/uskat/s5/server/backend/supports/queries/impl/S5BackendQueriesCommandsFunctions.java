...
class S5BackendQueriesCommandsFunctions
   ...
   */
  S5BackendQueriesCommandsFunctions( S5BaQueriesConvoy aQuery, String aParamId, IDtoQueryParam aArg,
   ...
   * @return {@link IList} список обработанных команд
   */
  @SuppressWarnings( "unchecked" )
  private <T> IList<T> nextCommand( IDtoCompletedCommand aCommand ) {
    rawCounter.add( 1 );
    if( aCommand == null ) {
