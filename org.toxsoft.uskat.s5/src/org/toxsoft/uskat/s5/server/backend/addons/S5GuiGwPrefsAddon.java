...
/**
 * Расширение бекенда: ISkGuiGwPrefsService
 *
 * @author mvk
 */
public final class S5GuiGwPrefsAddon
    extends S5BackendAddon {

  /**
   * Идентификатор адона.
   */
  public static final String SK_BACKEND_ADDON_ID = SK_ID + ".backend.addon.gprefs"; //$NON-NLS-1$

  /**
   * Конструктор
   */
  public S5GuiGwPrefsAddon() {
    super( SK_BACKEND_ADDON_ID, STR_N_BACKEND_GPREFS, STR_D_BACKEND_GPREFS );
  }
  ...
  protected IStringMap<AbstractSkService> doCreateServices( IDevCoreApi aCoreApi ) {
    ...
    retValue.put( ISkGuiGwPrefsService.SERVICE_ID, new SkGuiGwPrefsService( aCoreApi ) );
    return retValue;
  }
