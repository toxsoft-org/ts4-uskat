...
public class S5BatchOperationsSession
    extends S5BackendAddonSession
    implements IS5BatchOperationsRemote, IS5BatchOperationsSession {
   ...
   * Пустой конструктор.
   */
  public S5BatchOperationsSession() {
  ...
  protected Class<? extends IS5BackendAddonSession> doGetLocalView() {
    return IS5BatchOperationsSession.class;
  }

  @Override
  protected Class<? extends IS5BackendAddonRemote> doGetRemoteView() {
    return IS5BatchOperationsRemote.class;
  }
