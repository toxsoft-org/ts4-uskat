...
interface IS5Resources {
  ...
  String ERR_READ_CACHE_VALUE_NOT_FOUND      = "readValues(...): текущее данное не зарегистрировано gwid = %s";
  String ERR_WRITE_CACHE_VALUE_NOT_FOUND     =
      "writeValues(...): текущее данное не зарегистрировано gwid = %s для записи newValue = %s";
