...
public interface IS5EventHardConstants
  ...
  /**
   * Опция {@link ISkEventInfo#params()}: полное имя java-класса реализации блока.
   * <p>
  ...
  /**
   * Опция {@link ISkEventInfo#params()}: полное имя java-класса реализации blob значений.
   * <p>
   * Тип: {@link EAtomicType#STRING}
   */
  ...
  /**
   * Опция {@link ISkEventInfo#params()}: количество значений в одном блоке.
   * <p>
  ...
  /**
   * Опция {@link ISkEventInfo#params()}: максимальный размер одного значения (байты).
   * <p>
   * Тип: {@link EAtomicType#INTEGER}
   * <p>
