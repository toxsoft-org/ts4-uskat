...
/**
 * Расширение бекенда: 'Нормативно-справочная информация'
 *
 * @author mvk
 */
public final class S5RegRefAddon
    extends S5BackendAddon {

  /**
   * Идентификатор адона.
   */
  public static final String SK_BACKEND_ADDON_ID = SK_ID + ".backend.addon.regref"; //$NON-NLS-1$

  /**
   * Конструктор
   */
  public S5RegRefAddon() {
    super( SK_BACKEND_ADDON_ID, STR_N_BACKEND_REGREF, STR_D_BACKEND_REGREF );
  }
  ...
  protected IStringMap<AbstractSkService> doCreateServices( IDevCoreApi aCoreApi ) {
    ...
    retValue.put( ISkRegRefInfoService.SERVICE_ID, new SkRegRefInfoService( aCoreApi ) );
    return retValue;
  }
