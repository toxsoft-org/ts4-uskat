...
/**
 * Сообщение об завершении работы
 *
 * @author mvk
 */
public class S5BaBeforeCloseMessages
   ...
   * ID of the message.
   */
  public static final String MSG_ID = "BeforeClose"; //$NON-NLS-1$

  /**
   * Singletone intance.
   */
  public static final S5BaBeforeCloseMessages INSTANCE = new S5BaBeforeCloseMessages();

  S5BaBeforeCloseMessages() {
