...
public interface IS5BackendCoreConstants
   ...
   */
  String SYBSYSTEM_ID_PREFIX = ISkHardConstants.USKAT_FULL_ID + ".backend.s5.server";

  /**
   * Минимальное время (секунды) в котором сервер находится в режиме {@link ES5ServerMode#STARTING}.
   */
  IDataDef CORE_START_TIME_MIN = register( SYBSYSTEM_ID_PREFIX + ".startTimeMin", INTEGER, //
   ...
   */
  IDataDef CORE_START_TIME_MAX = register( SYBSYSTEM_ID_PREFIX + ".startTimeMax", INTEGER, //
   ...
   */
  IDataDef CORE_BOOSTED_AVERAGE = register( SYBSYSTEM_ID_PREFIX + ".boosted.average", FLOATING, //
   ...
   */
  IDataDef CORE_OVERLOADED_AVERAGE = register( SYBSYSTEM_ID_PREFIX + ".overloaded.average", FLOATING, //
