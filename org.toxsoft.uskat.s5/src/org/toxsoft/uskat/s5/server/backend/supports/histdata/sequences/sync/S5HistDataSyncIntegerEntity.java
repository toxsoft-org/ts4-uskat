 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity blob = new S5HistDataSyncIntegerBlobEntity( values );
    return new S5HistDataSyncIntegerEntity( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity blob = new S5HistDataSyncIntegerBlobEntity( aValues );
    return new S5HistDataSyncIntegerEntity( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity( aResultSet );
  }
