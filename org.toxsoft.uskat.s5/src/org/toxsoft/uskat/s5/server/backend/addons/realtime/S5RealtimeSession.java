...
public class S5RealtimeSession
  ...
  public void doAfterInit( S5SessionCallbackWriter aFrontend, IS5SessionInitData aInitData,
    ...
    frontendData.events.setNeededEventGwids( initData.eventGwids );
  ...
  public void setNeededEventGwids( IGwidList aNeededGwids ) {
    ...
    // Данные фронтенда
    S5RealtimeFrontendData frontendData =
        session.frontendData().getAddonData( SK_BACKEND_ADDON_ID, S5RealtimeFrontendData.class );
    // Поддержка подписки на события в сессии
    S5EventSupport eventSupport = frontendData.events;
    // Реконфигурация набора
