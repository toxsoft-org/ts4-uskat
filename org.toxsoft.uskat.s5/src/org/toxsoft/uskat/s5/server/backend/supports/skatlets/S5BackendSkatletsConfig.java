...
public final class S5BackendSkatletsConfig
   ...
   */
  public static final String SYBSYSTEM_ID_PREFIX = S5BackendCoreConfig.SYBSYSTEM_ID_PREFIX + ".skatlets";

  /**
   * Порядок загрузки скатлетов. Скатлеты не указанные в списке загружаются последними.
   */
  public static final IDataDef SKATLETS_LOAD_ORDERSKATLETS_LOAD_ORDER = register( SYBSYSTEM_ID_PREFIX + ".loadOrder", VALOBJ, //
