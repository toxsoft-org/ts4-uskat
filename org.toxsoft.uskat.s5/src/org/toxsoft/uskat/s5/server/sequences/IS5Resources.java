...
interface IS5Resources {
  ...
  String D_AUTO_REPAIR = Messages.getString( "IS5Resources.D_AUTO_REPAIR" ); //$NON-NLS-1$
  String N_AUTO_REPAIR = Messages.getString( "IS5Resources.N_AUTO_REPAIR" ); //$NON-NLS-1$
