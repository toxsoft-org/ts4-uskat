...
interface IS5Resources {
  ...
  String STR_N_VALUE_STORAGE_DEPTH = Messages.getString( "IS5Resources.STR_N_VALUE_STORAGE_DEPTH" ); //$NON-NLS-1$
  String STR_D_VALUE_STORAGE_DEPTH = Messages.getString( "IS5Resources.STR_D_VALUE_STORAGE_DEPTH" ); //$NON-NLS-1$
