...
public final class S5SequenceValidationConfig {
  ...
  public static final IDataDef VALIDATION_AUTO_REPAIR =
      create( SYBSYSTEM_ID_PREFIX + ".auto_repair", BOOLEAN, TSID_NAME, N_VALID_AUTO_REPAIR, //
  ...
  public static final IDataDef VALIDATION_INTERVAL =
      create( SYBSYSTEM_ID_PREFIX + ".interval", VALOBJ, TSID_NAME, N_VALID_INTERVAL, //
  ...
  public static final IDataDef VALIDATION_REPAIR =
      create( SYBSYSTEM_ID_PREFIX + ".repair", BOOLEAN, TSID_NAME, N_VALID_REPAIR, //
  ...
  public static final IDataDef VALIDATION_FORCE_REPAIR =
      create( SYBSYSTEM_ID_PREFIX + ".force_repair", BOOLEAN, TSID_NAME, N_VALID_FORCE_REPAIR, //
  ...
  public static final IDataDef VALIDATION_GWIDS =
      create( SYBSYSTEM_ID_PREFIX + ".ids", VALOBJ, TSID_NAME, N_VALID_GWIDS, //
