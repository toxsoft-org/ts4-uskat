...
public class UskatLOBFormatConverter {
  ...
  public static void main( String[] aArgs ) {
    // File oldFile = new File( "uskat-old.txt" );
    // File newFile = new File( "uskat-new.txt" );
    //
    // if( aArgs.length > 0 ) {
    ...
    // }
    // }
    // writer.write( text.substring( fromIndex, startIndex - 2 ) ); // \"
    // writer.write( '@' );
