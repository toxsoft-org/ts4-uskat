...
import static org.toxsoft.uskat.s5.schedules.supports.IS5Resources.*;
...
/**
 * Синглетон backend {@link IBaSchedules} предоставляемый s5-сервером.
 *
 * @author mvk
 */
@Startup
...
@Lock( LockType.READ )
public class S5BackendSchedulesSingleton
    extends S5BackendSupportSingleton
    implements IS5BackendSchedulesSingleton, IS5ObjectsInterceptor, IS5ServerJob {
   ...
   */
  public static final String BACKEND_SCHEDULES_ID = "S5BackendSchedulesSingleton"; //$NON-NLS-1$
   ...
   * Пустой конструктор.
   */
  public S5BackendSchedulesSingleton() {
    super( BACKEND_SCHEDULES_ID, ISkSchedulesHardConstants.BAINF_SCHEDULES.nmName() );
  }
