...
interface IS5Resources
  ...
  String ERR_CANT_UPDATE_SCHEDULE_CLASS = "Запрещено изменять класс расписания используемый службой ISkScheduleService";
  String ERR_CANT_REMOVE_SCHEDULE_CLASS = "Запрещено удалять класс расписания используемый службой ISkScheduleService";
