...
import static org.toxsoft.uskat.s5.schedules.lib.IS5Resources.*;
...
public interface ISkSchedulesHardConstants {
  ...
  // IBaSchedules
  //
  String BAID_SCHEDULES = ISkBackendHardConstant.SKB_ID + ".Schedules";

  IStridable BAINF_SCHEDULES = new Stridable( BAID_SCHEDULES, STR_N_BA_SCHEDULES, STR_D_BA_SCHEDULES );
