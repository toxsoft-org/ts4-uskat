 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity0
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity0> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity0} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity0 blob = new S5HistDataSyncFloatingBlobEntity0( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncFloatingEntity0( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncFloatingEntity0() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity0} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity0( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity0 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity0 blob = new S5HistDataSyncFloatingBlobEntity0( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity0( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity0 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity0( aResultSet );
  }
