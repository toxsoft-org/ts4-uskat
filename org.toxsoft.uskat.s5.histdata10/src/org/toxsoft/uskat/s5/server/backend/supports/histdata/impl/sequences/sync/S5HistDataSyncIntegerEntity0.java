 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity0
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity0> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity0} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity0 blob = new S5HistDataSyncIntegerBlobEntity0( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity0( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity0() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity0} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity0( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity0 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity0 blob = new S5HistDataSyncIntegerBlobEntity0( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity0( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity0 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity0( aResultSet );
  }
