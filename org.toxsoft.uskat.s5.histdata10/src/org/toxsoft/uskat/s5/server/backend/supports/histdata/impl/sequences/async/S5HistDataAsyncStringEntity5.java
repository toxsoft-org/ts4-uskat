 ...
 */
@Entity
public class S5HistDataAsyncStringEntity5
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity5> {
   ...
   * @return {@link S5HistDataAsyncStringEntity5} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity5 blob = new S5HistDataAsyncStringBlobEntity5( timestamps, values );
    return new S5HistDataAsyncStringEntity5( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity5() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity5} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity5( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity5 blob = new S5HistDataAsyncStringBlobEntity5( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity5( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity5( aResultSet );
  }
