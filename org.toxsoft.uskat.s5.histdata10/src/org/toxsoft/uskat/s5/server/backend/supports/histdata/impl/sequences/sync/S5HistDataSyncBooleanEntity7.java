 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity7
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity7> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity7} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity7 blob = new S5HistDataSyncBooleanBlobEntity7( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity7( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity7() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity7} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity7( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity7 blob = new S5HistDataSyncBooleanBlobEntity7( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity7( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity7( aResultSet );
  }
