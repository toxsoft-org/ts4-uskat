 ...
 */
@Entity
public class S5HistDataSyncStringBlobEntity4
    extends S5SequenceSyncBlob<S5HistDataSyncStringEntity4, String[], String[]> {
   ...
   */
  protected S5HistDataSyncStringBlobEntity4() {
  }
   ...
   */
  S5HistDataSyncStringBlobEntity4( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncStringBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
