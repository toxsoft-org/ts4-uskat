 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity9
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity9> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity9} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity9 blob = new S5HistDataSyncTimestampBlobEntity9( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity9( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity9() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity9} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity9( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity9 blob =
        new S5HistDataSyncTimestampBlobEntity9( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity9( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity9( aResultSet );
  }
