 ...
 */
@Entity
public class S5HistDataSyncIntegerBlobEntity3
    extends S5SequenceSyncBlob<S5HistDataSyncIntegerEntity3, long[], long[]> {
   ...
   */
  protected S5HistDataSyncIntegerBlobEntity3() {
  }
   ...
   */
  S5HistDataSyncIntegerBlobEntity3( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncIntegerBlobEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
