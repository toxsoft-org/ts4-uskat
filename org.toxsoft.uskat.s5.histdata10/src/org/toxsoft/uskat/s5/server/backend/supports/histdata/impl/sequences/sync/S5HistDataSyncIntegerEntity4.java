 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity4
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity4> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity4} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity4 blob = new S5HistDataSyncIntegerBlobEntity4( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity4( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity4() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity4} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity4( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity4 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity4 blob = new S5HistDataSyncIntegerBlobEntity4( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity4( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity4 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity4( aResultSet );
  }
