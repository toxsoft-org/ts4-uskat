 ...
 */
@Entity
public class S5HistDataSyncBooleanBlobEntity2
    extends S5SequenceSyncBlob<S5HistDataSyncBooleanEntity2, byte[], byte[]> {
   ...
   */
  protected S5HistDataSyncBooleanBlobEntity2() {
  }
   ...
   */
  S5HistDataSyncBooleanBlobEntity2( byte[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncBooleanBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
