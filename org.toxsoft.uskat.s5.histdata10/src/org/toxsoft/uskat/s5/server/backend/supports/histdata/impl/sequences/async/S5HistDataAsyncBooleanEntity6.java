 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity6
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity6> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity6} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity6 blob = new S5HistDataAsyncBooleanBlobEntity6( timestamps, values );
    return new S5HistDataAsyncBooleanEntity6( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity6() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity6} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity6( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity6 blob = new S5HistDataAsyncBooleanBlobEntity6( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity6( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity6( aResultSet );
  }
