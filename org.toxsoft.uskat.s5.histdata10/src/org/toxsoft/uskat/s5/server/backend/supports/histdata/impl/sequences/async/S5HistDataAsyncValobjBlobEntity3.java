 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity3
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity3, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity3() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity3( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
