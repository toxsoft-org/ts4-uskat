 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity5
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity5> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity5} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity5 blob = new S5HistDataAsyncTimestampBlobEntity5( timestamps, values );
    return new S5HistDataAsyncTimestampEntity5( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity5() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity5} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity5( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity5 blob = new S5HistDataAsyncTimestampBlobEntity5( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity5( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity5( aResultSet );
  }
