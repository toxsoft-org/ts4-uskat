 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity3
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity3, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity3() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity3( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
