 ...
 */
@Entity
public class S5HistDataSyncStringEntity0
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity0> {
   ...
   * @return {@link S5HistDataSyncStringEntity0} блок значений
   ...
   */
  static S5HistDataSyncStringEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity0 blob = new S5HistDataSyncStringBlobEntity0( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity0( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity0() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity0} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity0( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity0 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity0 blob = new S5HistDataSyncStringBlobEntity0( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity0( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity0 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity0( aResultSet );
  }
