 ...
 */
@Entity
public class S5HistDataAsyncStringBlobEntity5
    extends S5SequenceAsyncBlob<S5HistDataAsyncStringEntity5, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncStringBlobEntity5() {
  }
   ...
   */
  S5HistDataAsyncStringBlobEntity5( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncStringBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
