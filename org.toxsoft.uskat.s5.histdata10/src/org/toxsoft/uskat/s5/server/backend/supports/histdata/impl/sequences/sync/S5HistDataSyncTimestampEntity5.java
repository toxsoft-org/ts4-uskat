 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity5
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity5> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity5} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity5 blob = new S5HistDataSyncTimestampBlobEntity5( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity5( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity5() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity5} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity5( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity5 blob =
        new S5HistDataSyncTimestampBlobEntity5( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity5( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity5( aResultSet );
  }
