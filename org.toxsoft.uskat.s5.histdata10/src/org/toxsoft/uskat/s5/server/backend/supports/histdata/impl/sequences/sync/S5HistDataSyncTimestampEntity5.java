...
public class S5HistDataSyncTimestampEntity5
  ...
  static S5HistDataSyncTimestampEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity5 blob = new S5HistDataSyncTimestampBlobEntity5( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncTimestampBlobEntity5 blob = new S5HistDataSyncTimestampBlobEntity5( aValues );
