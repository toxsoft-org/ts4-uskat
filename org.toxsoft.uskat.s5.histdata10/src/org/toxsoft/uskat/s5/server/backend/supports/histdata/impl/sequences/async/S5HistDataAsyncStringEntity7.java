 ...
 */
@Entity
public class S5HistDataAsyncStringEntity7
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity7> {
   ...
   * @return {@link S5HistDataAsyncStringEntity7} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity7 blob = new S5HistDataAsyncStringBlobEntity7( timestamps, values );
    return new S5HistDataAsyncStringEntity7( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity7() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity7} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity7( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity7 blob = new S5HistDataAsyncStringBlobEntity7( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity7( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity7( aResultSet );
  }
