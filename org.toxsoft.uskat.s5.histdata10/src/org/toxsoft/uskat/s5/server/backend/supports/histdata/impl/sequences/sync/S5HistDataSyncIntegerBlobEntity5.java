 ...
 */
@Entity
public class S5HistDataSyncIntegerBlobEntity5
    extends S5SequenceSyncBlob<S5HistDataSyncIntegerEntity5, long[], long[]> {
   ...
   */
  protected S5HistDataSyncIntegerBlobEntity5() {
  }
   ...
   */
  S5HistDataSyncIntegerBlobEntity5( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncIntegerBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
