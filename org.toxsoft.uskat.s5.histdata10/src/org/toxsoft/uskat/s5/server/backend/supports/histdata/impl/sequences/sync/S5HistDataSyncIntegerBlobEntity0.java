...
public class S5HistDataSyncIntegerBlobEntity0
   ...
   */
  protected S5HistDataSyncIntegerBlobEntity0() {
  }
   ...
   */
  S5HistDataSyncIntegerBlobEntity0( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncIntegerBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
