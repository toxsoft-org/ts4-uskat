 ...
 */
@Entity
public class S5HistDataSyncValobjEntity9
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity9> {
   ...
   * @return {@link S5HistDataSyncValobjEntity9} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity9 blob = new S5HistDataSyncValobjBlobEntity9( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity9( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity9() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity9} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity9( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity9 blob = new S5HistDataSyncValobjBlobEntity9( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity9( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity9( aResultSet );
  }
