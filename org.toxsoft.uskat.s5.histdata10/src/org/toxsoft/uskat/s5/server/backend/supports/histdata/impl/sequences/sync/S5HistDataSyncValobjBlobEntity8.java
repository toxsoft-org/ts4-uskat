 ...
 */
@Entity
public class S5HistDataSyncValobjBlobEntity8
    extends S5SequenceSyncBlob<S5HistDataSyncValobjEntity8, String[], String[]> {
   ...
   */
  protected S5HistDataSyncValobjBlobEntity8() {
  }
   ...
   */
  S5HistDataSyncValobjBlobEntity8( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncValobjBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
