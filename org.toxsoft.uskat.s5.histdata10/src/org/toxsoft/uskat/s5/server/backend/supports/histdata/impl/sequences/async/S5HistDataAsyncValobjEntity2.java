 ...
 */
@Entity
public class S5HistDataAsyncValobjEntity2
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncValobjBlobEntity2> {
   ...
   * @return {@link S5HistDataAsyncValobjEntity2} блок значений
   ...
   */
  static S5HistDataAsyncValobjEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncValobjBlobEntity2 blob = new S5HistDataAsyncValobjBlobEntity2( timestamps, values );
    return new S5HistDataAsyncValobjEntity2( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncValobjEntity2() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncValobjBlobEntity2} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncValobjEntity2( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncValobjBlobEntity2 aBlob ) {
   ...
   */
  S5HistDataAsyncValobjEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncValobjBlobEntity2 blob = new S5HistDataAsyncValobjBlobEntity2( aTimestamps, aValues );
    return new S5HistDataAsyncValobjEntity2( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncValobjBlobEntity2 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncValobjBlobEntity2( aResultSet );
  }
