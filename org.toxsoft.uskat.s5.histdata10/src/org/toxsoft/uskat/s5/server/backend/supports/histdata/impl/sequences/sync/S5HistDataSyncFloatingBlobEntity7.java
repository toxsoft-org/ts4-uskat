 ...
 */
@Entity
public class S5HistDataSyncFloatingBlobEntity7
    extends S5SequenceSyncBlob<S5HistDataSyncFloatingEntity7, double[], double[]> {
   ...
   */
  protected S5HistDataSyncFloatingBlobEntity7() {
  }
   ...
   */
  S5HistDataSyncFloatingBlobEntity7( double[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncFloatingBlobEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
