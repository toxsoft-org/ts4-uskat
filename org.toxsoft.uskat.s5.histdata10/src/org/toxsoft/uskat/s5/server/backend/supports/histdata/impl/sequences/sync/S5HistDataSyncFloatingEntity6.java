 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity6
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity6> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity6} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity6 blob = new S5HistDataSyncFloatingBlobEntity6( values, Long.valueOf( endTime ) );
   ...
   */
  protected S5HistDataSyncFloatingEntity6() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity6} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity6( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity6 blob = new S5HistDataSyncFloatingBlobEntity6( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity6( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity6( aResultSet );
  }
