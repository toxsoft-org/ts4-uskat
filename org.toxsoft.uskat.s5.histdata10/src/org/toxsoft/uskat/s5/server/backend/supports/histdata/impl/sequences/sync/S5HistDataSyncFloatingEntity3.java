 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity3
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity3> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity3} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity3 blob = new S5HistDataSyncFloatingBlobEntity3( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncFloatingEntity3( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncFloatingEntity3() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity3} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity3( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity3 blob = new S5HistDataSyncFloatingBlobEntity3( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity3( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity3( aResultSet );
  }
