 ...
 */
@Entity
public class S5HistDataSyncStringEntity8
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity8> {
   ...
   * @return {@link S5HistDataSyncStringEntity8} блок значений
   ...
   */
  static S5HistDataSyncStringEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity8 blob = new S5HistDataSyncStringBlobEntity8( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity8( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity8() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity8} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity8( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity8 blob = new S5HistDataSyncStringBlobEntity8( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity8( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity8( aResultSet );
  }
