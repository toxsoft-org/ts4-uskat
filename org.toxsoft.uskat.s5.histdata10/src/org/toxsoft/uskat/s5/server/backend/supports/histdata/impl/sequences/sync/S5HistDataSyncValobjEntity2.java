...
public class S5HistDataSyncValobjEntity2
  ...
  static S5HistDataSyncValobjEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity2 blob = new S5HistDataSyncValobjBlobEntity2( values );
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncValobjBlobEntity2 blob = new S5HistDataSyncValobjBlobEntity2( aValues );
