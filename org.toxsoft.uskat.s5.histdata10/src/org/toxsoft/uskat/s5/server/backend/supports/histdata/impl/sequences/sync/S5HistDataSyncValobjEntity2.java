 ...
 */
@Entity
public class S5HistDataSyncValobjEntity2
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity2> {
   ...
   * @return {@link S5HistDataSyncValobjEntity2} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity2 blob = new S5HistDataSyncValobjBlobEntity2( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity2( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity2() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity2} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity2( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity2 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity2 blob = new S5HistDataSyncValobjBlobEntity2( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity2( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity2 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity2( aResultSet );
  }
