 ...
 */
@Entity
public class S5HistDataSyncBooleanBlobEntity0
    extends S5SequenceSyncBlob<S5HistDataSyncBooleanEntity0, byte[], byte[]> {
   ...
   */
  protected S5HistDataSyncBooleanBlobEntity0() {
  }
   ...
   */
  S5HistDataSyncBooleanBlobEntity0( byte[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncBooleanBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
