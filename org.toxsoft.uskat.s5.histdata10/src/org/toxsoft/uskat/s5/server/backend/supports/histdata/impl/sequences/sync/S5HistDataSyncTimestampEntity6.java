 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity6
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity6> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity6} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity6 blob = new S5HistDataSyncTimestampBlobEntity6( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity6( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity6() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity6} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity6( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity6 blob =
        new S5HistDataSyncTimestampBlobEntity6( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity6( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity6( aResultSet );
  }
