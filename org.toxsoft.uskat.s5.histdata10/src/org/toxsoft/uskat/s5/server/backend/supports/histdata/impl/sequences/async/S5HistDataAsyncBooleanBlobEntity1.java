 ...
 */
@Entity
public class S5HistDataAsyncBooleanBlobEntity1
    extends S5SequenceAsyncBlob<S5HistDataAsyncBooleanEntity1, byte[], byte[]> {
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity1() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity1( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
