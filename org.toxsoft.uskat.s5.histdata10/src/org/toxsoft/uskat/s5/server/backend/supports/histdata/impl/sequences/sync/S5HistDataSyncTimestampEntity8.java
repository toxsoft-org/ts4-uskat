 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity8
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity8> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity8} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity8 blob = new S5HistDataSyncTimestampBlobEntity8( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity8( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity8() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity8} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity8( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity8 blob =
        new S5HistDataSyncTimestampBlobEntity8( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity8( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity8( aResultSet );
  }
