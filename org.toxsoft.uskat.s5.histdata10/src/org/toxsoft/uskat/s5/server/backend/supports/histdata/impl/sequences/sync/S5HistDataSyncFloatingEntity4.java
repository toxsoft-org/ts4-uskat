 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity4
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity4> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity4} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity4 blob = new S5HistDataSyncFloatingBlobEntity4( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncFloatingEntity4( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncFloatingEntity4() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity4} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity4( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity4 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity4 blob = new S5HistDataSyncFloatingBlobEntity4( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity4( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity4 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity4( aResultSet );
  }
