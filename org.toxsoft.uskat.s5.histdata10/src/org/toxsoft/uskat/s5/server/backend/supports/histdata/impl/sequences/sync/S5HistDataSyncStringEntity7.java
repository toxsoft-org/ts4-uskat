 ...
 */
@Entity
public class S5HistDataSyncStringEntity7
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity7> {
   ...
   * @return {@link S5HistDataSyncStringEntity7} блок значений
   ...
   */
  static S5HistDataSyncStringEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity7 blob = new S5HistDataSyncStringBlobEntity7( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity7( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity7() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity7} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity7( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity7 blob = new S5HistDataSyncStringBlobEntity7( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity7( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity7( aResultSet );
  }
