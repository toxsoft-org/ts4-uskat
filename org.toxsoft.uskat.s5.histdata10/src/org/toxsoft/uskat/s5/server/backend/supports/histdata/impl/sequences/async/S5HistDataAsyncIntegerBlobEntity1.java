 ...
 */
@Entity
public class S5HistDataAsyncIntegerBlobEntity1
    extends S5SequenceAsyncBlob<S5HistDataAsyncIntegerEntity1, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncIntegerBlobEntity1() {
  }
   ...
   */
  S5HistDataAsyncIntegerBlobEntity1( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncIntegerBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
