 ...
 */
@Entity
public class S5HistDataAsyncTimestampBlobEntity4
    extends S5SequenceAsyncBlob<S5HistDataAsyncTimestampEntity4, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity4() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity4( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
