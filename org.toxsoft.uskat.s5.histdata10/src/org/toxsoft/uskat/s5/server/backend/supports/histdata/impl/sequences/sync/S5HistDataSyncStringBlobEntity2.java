 ...
 */
@Entity
public class S5HistDataSyncStringBlobEntity2
    extends S5SequenceSyncBlob<S5HistDataSyncStringEntity2, String[], String[]> {
   ...
   */
  protected S5HistDataSyncStringBlobEntity2() {
  }
   ...
   */
  S5HistDataSyncStringBlobEntity2( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncStringBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
