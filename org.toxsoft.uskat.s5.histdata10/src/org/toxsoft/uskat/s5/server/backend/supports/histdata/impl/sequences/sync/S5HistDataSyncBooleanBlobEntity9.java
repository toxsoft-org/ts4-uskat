 ...
 */
@Entity
public class S5HistDataSyncBooleanBlobEntity9
    extends S5SequenceSyncBlob<S5HistDataSyncBooleanEntity9, byte[], byte[]> {
   ...
   */
  protected S5HistDataSyncBooleanBlobEntity9() {
  }
   ...
   */
  S5HistDataSyncBooleanBlobEntity9( byte[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncBooleanBlobEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
