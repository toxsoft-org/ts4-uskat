 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity6
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity6> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity6} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity6 blob = new S5HistDataSyncBooleanBlobEntity6( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity6( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity6() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity6} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity6( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity6 blob = new S5HistDataSyncBooleanBlobEntity6( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity6( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity6( aResultSet );
  }
