 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity4
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity4> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity4} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity4 blob = new S5HistDataSyncTimestampBlobEntity4( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity4( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity4() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity4} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity4( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity4 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity4 blob =
        new S5HistDataSyncTimestampBlobEntity4( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity4( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity4 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity4( aResultSet );
  }
