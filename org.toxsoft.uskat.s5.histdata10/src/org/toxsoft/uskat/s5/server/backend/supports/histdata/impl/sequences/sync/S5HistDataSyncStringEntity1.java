...
public class S5HistDataSyncStringEntity1
  ...
  static S5HistDataSyncStringEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity1 blob = new S5HistDataSyncStringBlobEntity1( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncStringBlobEntity1 blob = new S5HistDataSyncStringBlobEntity1( aValues );
