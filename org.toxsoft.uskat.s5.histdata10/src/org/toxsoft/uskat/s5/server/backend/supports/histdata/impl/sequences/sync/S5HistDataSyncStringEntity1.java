 ...
 */
@Entity
public class S5HistDataSyncStringEntity1
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity1> {
   ...
   * @return {@link S5HistDataSyncStringEntity1} блок значений
   ...
   */
  static S5HistDataSyncStringEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity1 blob = new S5HistDataSyncStringBlobEntity1( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity1( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity1() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity1} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity1( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity1 blob = new S5HistDataSyncStringBlobEntity1( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity1( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity1( aResultSet );
  }
