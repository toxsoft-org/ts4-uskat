 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity1
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity1> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity1} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity1 blob = new S5HistDataSyncFloatingBlobEntity1( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncFloatingEntity1( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncFloatingEntity1() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity1} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity1( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity1 blob = new S5HistDataSyncFloatingBlobEntity1( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity1( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity1( aResultSet );
  }
