 ...
 */
@Entity
public class S5HistDataAsyncTimestampBlobEntity2
    extends S5SequenceAsyncBlob<S5HistDataAsyncTimestampEntity2, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity2() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity2( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
