...
public class S5HistDataSyncBooleanEntity0
  ...
  static S5HistDataSyncBooleanEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity0 blob = new S5HistDataSyncBooleanBlobEntity0( values, endTime );
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity0 blob = new S5HistDataSyncBooleanBlobEntity0( aValues, aEndTime );
