 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity0
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity0> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity0} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity0 blob = new S5HistDataSyncBooleanBlobEntity0( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity0( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity0() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity0} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity0( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity0 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity0 blob = new S5HistDataSyncBooleanBlobEntity0( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity0( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity0 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity0( aResultSet );
  }
