 ...
 */
@Entity
public class S5HistDataSyncTimestampBlobEntity3
    extends S5SequenceSyncBlob<S5HistDataSyncTimestampEntity3, long[], long[]> {
   ...
   */
  protected S5HistDataSyncTimestampBlobEntity3() {
  }
   ...
   */
  S5HistDataSyncTimestampBlobEntity3( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncTimestampBlobEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
