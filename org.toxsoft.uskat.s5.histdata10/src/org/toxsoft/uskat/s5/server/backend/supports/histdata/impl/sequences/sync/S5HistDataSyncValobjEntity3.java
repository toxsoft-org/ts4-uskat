 ...
 */
@Entity
public class S5HistDataSyncValobjEntity3
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity3> {
   ...
   * @return {@link S5HistDataSyncValobjEntity3} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity3 blob = new S5HistDataSyncValobjBlobEntity3( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity3( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity3() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity3} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity3( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity3 blob = new S5HistDataSyncValobjBlobEntity3( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity3( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity3( aResultSet );
  }
