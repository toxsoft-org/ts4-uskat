 ...
 */
@Entity
public class S5HistDataSyncValobjBlobEntity9
    extends S5SequenceSyncBlob<S5HistDataSyncValobjEntity9, String[], String[]> {
   ...
   */
  protected S5HistDataSyncValobjBlobEntity9() {
  }
   ...
   */
  S5HistDataSyncValobjBlobEntity9( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncValobjBlobEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
