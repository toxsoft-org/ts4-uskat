 ...
 */
@Entity
public class S5HistDataSyncValobjEntity5
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity5> {
   ...
   * @return {@link S5HistDataSyncValobjEntity5} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity5 blob = new S5HistDataSyncValobjBlobEntity5( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity5( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity5() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity5} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity5( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity5 blob = new S5HistDataSyncValobjBlobEntity5( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity5( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity5( aResultSet );
  }
