 ...
 */
@Entity
public class S5HistDataSyncIntegerBlobEntity8
    extends S5SequenceSyncBlob<S5HistDataSyncIntegerEntity8, long[], long[]> {
   ...
   */
  protected S5HistDataSyncIntegerBlobEntity8() {
  }
   ...
   */
  S5HistDataSyncIntegerBlobEntity8( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncIntegerBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
