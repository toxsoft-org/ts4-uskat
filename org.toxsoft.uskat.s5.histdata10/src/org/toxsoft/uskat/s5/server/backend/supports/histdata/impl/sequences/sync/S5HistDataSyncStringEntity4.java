...
public class S5HistDataSyncStringEntity4
  ...
  static S5HistDataSyncStringEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity4 blob = new S5HistDataSyncStringBlobEntity4( values, Long.valueOf( endTime ) );
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity4 blob = new S5HistDataSyncStringBlobEntity4( aValues, Long.valueOf( aEndTime ) );
