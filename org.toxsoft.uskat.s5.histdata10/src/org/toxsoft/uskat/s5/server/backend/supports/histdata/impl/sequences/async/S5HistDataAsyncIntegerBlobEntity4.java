 ...
 */
@Entity
public class S5HistDataAsyncIntegerBlobEntity4
    extends S5SequenceAsyncBlob<S5HistDataAsyncIntegerEntity4, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncIntegerBlobEntity4() {
  }
   ...
   */
  S5HistDataAsyncIntegerBlobEntity4( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncIntegerBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
