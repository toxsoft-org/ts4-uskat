 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity4
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity4> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity4} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity4 blob = new S5HistDataAsyncTimestampBlobEntity4( timestamps, values );
    return new S5HistDataAsyncTimestampEntity4( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity4() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity4} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity4( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity4 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity4 blob = new S5HistDataAsyncTimestampBlobEntity4( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity4( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity4 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity4( aResultSet );
  }
