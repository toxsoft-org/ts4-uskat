 ...
 */
@Entity
public class S5HistDataSyncValobjBlobEntity0
    extends S5SequenceSyncBlob<S5HistDataSyncValobjEntity0, String[], String[]> {
   ...
   */
  protected S5HistDataSyncValobjBlobEntity0() {
  }
   ...
   */
  S5HistDataSyncValobjBlobEntity0( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncValobjBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
