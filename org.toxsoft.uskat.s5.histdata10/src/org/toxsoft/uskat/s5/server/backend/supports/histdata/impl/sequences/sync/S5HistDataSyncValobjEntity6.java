 ...
 */
@Entity
public class S5HistDataSyncValobjEntity6
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity6> {
   ...
   * @return {@link S5HistDataSyncValobjEntity6} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity6 blob = new S5HistDataSyncValobjBlobEntity6( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity6( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity6() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity6} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity6( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity6 blob = new S5HistDataSyncValobjBlobEntity6( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity6( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity6( aResultSet );
  }
