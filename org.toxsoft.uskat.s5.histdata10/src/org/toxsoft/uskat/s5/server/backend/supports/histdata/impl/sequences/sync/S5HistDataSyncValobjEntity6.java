...
public class S5HistDataSyncValobjEntity6
  ...
  static S5HistDataSyncValobjEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity6 blob = new S5HistDataSyncValobjBlobEntity6( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncValobjBlobEntity6 blob = new S5HistDataSyncValobjBlobEntity6( aValues );
