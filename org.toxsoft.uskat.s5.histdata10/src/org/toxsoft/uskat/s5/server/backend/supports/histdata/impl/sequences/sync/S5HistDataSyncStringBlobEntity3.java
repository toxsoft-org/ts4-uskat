 ...
 */
@Entity
public class S5HistDataSyncStringBlobEntity3
    extends S5SequenceSyncBlob<S5HistDataSyncStringEntity3, String[], String[]> {
   ...
   */
  protected S5HistDataSyncStringBlobEntity3() {
  }
   ...
   */
  S5HistDataSyncStringBlobEntity3( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncStringBlobEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
