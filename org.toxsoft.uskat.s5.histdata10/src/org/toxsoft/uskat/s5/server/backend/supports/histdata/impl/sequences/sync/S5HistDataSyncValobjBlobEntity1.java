 ...
 */
@Entity
public class S5HistDataSyncValobjBlobEntity1
    extends S5SequenceSyncBlob<S5HistDataSyncValobjEntity1, String[], String[]> {
   ...
   */
  protected S5HistDataSyncValobjBlobEntity1() {
  }
   ...
   */
  S5HistDataSyncValobjBlobEntity1( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncValobjBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
