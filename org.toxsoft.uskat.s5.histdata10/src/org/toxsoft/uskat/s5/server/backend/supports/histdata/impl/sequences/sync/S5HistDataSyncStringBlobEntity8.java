 ...
 */
@Entity
public class S5HistDataSyncStringBlobEntity8
    extends S5SequenceSyncBlob<S5HistDataSyncStringEntity8, String[], String[]> {
   ...
   */
  protected S5HistDataSyncStringBlobEntity8() {
  }
   ...
   */
  S5HistDataSyncStringBlobEntity8( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncStringBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
