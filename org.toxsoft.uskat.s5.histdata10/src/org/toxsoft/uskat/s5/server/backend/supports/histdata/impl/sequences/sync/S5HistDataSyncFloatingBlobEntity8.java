 ...
 */
@Entity
public class S5HistDataSyncFloatingBlobEntity8
    extends S5SequenceSyncBlob<S5HistDataSyncFloatingEntity8, double[], double[]> {
   ...
   */
  protected S5HistDataSyncFloatingBlobEntity8() {
  }
   ...
   */
  S5HistDataSyncFloatingBlobEntity8( double[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncFloatingBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
