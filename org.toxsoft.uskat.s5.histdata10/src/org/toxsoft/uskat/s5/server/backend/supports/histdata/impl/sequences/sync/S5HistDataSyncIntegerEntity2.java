...
public class S5HistDataSyncIntegerEntity2
  ...
  static S5HistDataSyncIntegerEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity2 blob = new S5HistDataSyncIntegerBlobEntity2( values, endTime );
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity2 blob = new S5HistDataSyncIntegerBlobEntity2( aValues, aEndTime );
