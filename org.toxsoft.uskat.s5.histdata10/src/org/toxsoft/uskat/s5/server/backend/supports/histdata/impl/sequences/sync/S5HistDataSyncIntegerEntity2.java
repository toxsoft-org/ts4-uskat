 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity2
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity2> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity2} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity2 blob = new S5HistDataSyncIntegerBlobEntity2( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity2( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity2() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity2} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity2( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity2 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity2 blob = new S5HistDataSyncIntegerBlobEntity2( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity2( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity2 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity2( aResultSet );
  }
