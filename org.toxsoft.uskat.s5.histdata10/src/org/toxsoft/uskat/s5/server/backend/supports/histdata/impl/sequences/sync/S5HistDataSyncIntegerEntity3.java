 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity3
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity3> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity3} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity3 blob = new S5HistDataSyncIntegerBlobEntity3( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity3( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity3() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity3} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity3( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity3 blob = new S5HistDataSyncIntegerBlobEntity3( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity3( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity3( aResultSet );
  }
