...
public class S5HistDataSyncValobjEntity1
  ...
  static S5HistDataSyncValobjEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity1 blob = new S5HistDataSyncValobjBlobEntity1( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncValobjBlobEntity1 blob = new S5HistDataSyncValobjBlobEntity1( aValues );
