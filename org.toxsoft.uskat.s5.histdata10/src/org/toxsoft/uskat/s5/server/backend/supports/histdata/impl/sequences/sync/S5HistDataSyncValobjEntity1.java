 ...
 */
@Entity
public class S5HistDataSyncValobjEntity1
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity1> {
   ...
   * @return {@link S5HistDataSyncValobjEntity1} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity1 blob = new S5HistDataSyncValobjBlobEntity1( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity1( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity1() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity1} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity1( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity1 blob = new S5HistDataSyncValobjBlobEntity1( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity1( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity1( aResultSet );
  }
