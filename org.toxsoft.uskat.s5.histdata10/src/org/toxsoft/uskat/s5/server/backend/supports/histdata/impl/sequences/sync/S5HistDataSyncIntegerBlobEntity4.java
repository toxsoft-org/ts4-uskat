 ...
 */
@Entity
public class S5HistDataSyncIntegerBlobEntity4
    extends S5SequenceSyncBlob<S5HistDataSyncIntegerEntity4, long[], long[]> {
   ...
   */
  protected S5HistDataSyncIntegerBlobEntity4() {
  }
   ...
   */
  S5HistDataSyncIntegerBlobEntity4( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncIntegerBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
