...
public class S5HistDataSyncFloatingEntity5
  ...
  static S5HistDataSyncFloatingEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity5 blob = new S5HistDataSyncFloatingBlobEntity5( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      double[] aValues ) {
    S5HistDataSyncFloatingBlobEntity5 blob = new S5HistDataSyncFloatingBlobEntity5( aValues );
