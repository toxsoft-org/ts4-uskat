 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity5
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity5> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity5} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity5 blob = new S5HistDataSyncFloatingBlobEntity5( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncFloatingEntity5( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncFloatingEntity5() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity5} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity5( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity5 blob = new S5HistDataSyncFloatingBlobEntity5( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity5( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity5( aResultSet );
  }
