 ...
 */
@Entity
public class S5HistDataAsyncBooleanBlobEntity4
    extends S5SequenceAsyncBlob<S5HistDataAsyncBooleanEntity4, byte[], byte[]> {
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity4() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity4( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
