...
public class S5HistDataSyncFloatingEntity9
  ...
  static S5HistDataSyncFloatingEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity9 blob = new S5HistDataSyncFloatingBlobEntity9( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      double[] aValues ) {
    S5HistDataSyncFloatingBlobEntity9 blob = new S5HistDataSyncFloatingBlobEntity9( aValues );
