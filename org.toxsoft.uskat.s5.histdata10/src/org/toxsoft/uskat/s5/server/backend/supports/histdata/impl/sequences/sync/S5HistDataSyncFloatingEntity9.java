 ...
 */
@Entity
public class S5HistDataSyncFloatingEntity9
    extends S5HistDataSyncBlock<double[], S5HistDataSyncFloatingBlobEntity9> {
   ...
   * @return {@link S5HistDataSyncFloatingEntity9} блок значений
   ...
   */
  static S5HistDataSyncFloatingEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity9 blob = new S5HistDataSyncFloatingBlobEntity9( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncFloatingEntity9( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncFloatingEntity9() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncFloatingBlobEntity9} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncFloatingEntity9( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncFloatingBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataSyncFloatingEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncFloatingBlobEntity9 blob = new S5HistDataSyncFloatingBlobEntity9( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncFloatingEntity9( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncFloatingBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncFloatingBlobEntity9( aResultSet );
  }
