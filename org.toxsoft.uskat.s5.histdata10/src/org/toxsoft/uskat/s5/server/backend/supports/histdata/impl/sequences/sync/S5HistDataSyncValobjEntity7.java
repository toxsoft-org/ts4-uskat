 ...
 */
@Entity
public class S5HistDataSyncValobjEntity7
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity7> {
   ...
   * @return {@link S5HistDataSyncValobjEntity7} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity7 blob = new S5HistDataSyncValobjBlobEntity7( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity7( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity7() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity7} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity7( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity7 blob = new S5HistDataSyncValobjBlobEntity7( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity7( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity7( aResultSet );
  }
