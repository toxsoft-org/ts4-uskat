 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity9
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity9> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity9} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity9 blob = new S5HistDataAsyncTimestampBlobEntity9( timestamps, values );
    return new S5HistDataAsyncTimestampEntity9( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity9() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity9} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity9( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity9 blob = new S5HistDataAsyncTimestampBlobEntity9( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity9( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity9( aResultSet );
  }
