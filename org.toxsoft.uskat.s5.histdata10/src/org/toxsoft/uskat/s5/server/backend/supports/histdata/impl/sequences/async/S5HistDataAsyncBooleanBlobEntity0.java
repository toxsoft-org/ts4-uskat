 ...
 */
@Entity
public class S5HistDataAsyncBooleanBlobEntity0
    extends S5SequenceAsyncBlob<S5HistDataAsyncBooleanEntity0, byte[], byte[]> {
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity0() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity0( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
