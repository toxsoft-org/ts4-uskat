 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity3
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity3> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity3} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity3 blob = new S5HistDataSyncTimestampBlobEntity3( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity3( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity3() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity3} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity3( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity3 blob =
        new S5HistDataSyncTimestampBlobEntity3( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity3( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity3( aResultSet );
  }
