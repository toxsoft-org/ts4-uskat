 ...
 */
@Entity
public class S5HistDataSyncValobjEntity8
    extends S5HistDataSyncBlock<String[], S5HistDataSyncValobjBlobEntity8> {
   ...
   * @return {@link S5HistDataSyncValobjEntity8} блок значений
   ...
   */
  static S5HistDataSyncValobjEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity8 blob = new S5HistDataSyncValobjBlobEntity8( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncValobjEntity8( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncValobjEntity8() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncValobjBlobEntity8} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncValobjEntity8( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncValobjBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataSyncValobjEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncValobjBlobEntity8 blob = new S5HistDataSyncValobjBlobEntity8( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncValobjEntity8( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncValobjBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncValobjBlobEntity8( aResultSet );
  }
