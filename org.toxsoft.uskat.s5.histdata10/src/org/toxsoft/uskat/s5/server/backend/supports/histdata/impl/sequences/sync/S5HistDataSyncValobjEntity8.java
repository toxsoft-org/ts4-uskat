...
public class S5HistDataSyncValobjEntity8
  ...
  static S5HistDataSyncValobjEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncValobjBlobEntity8 blob = new S5HistDataSyncValobjBlobEntity8( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncValobjBlobEntity8 blob = new S5HistDataSyncValobjBlobEntity8( aValues );
