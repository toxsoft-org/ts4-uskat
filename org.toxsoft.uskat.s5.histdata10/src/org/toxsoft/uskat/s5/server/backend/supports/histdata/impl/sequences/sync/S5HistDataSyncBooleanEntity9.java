...
public class S5HistDataSyncBooleanEntity9
  ...
  static S5HistDataSyncBooleanEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity9 blob = new S5HistDataSyncBooleanBlobEntity9( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity9 blob = new S5HistDataSyncBooleanBlobEntity9( aValues );
