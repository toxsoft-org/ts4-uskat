 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity9
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity9> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity9} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity9 blob = new S5HistDataSyncBooleanBlobEntity9( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity9( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity9() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity9} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity9( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity9 blob = new S5HistDataSyncBooleanBlobEntity9( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity9( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity9( aResultSet );
  }
