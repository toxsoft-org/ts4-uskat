 ...
 */
@Entity
public class S5HistDataSyncStringEntity6
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity6> {
   ...
   * @return {@link S5HistDataSyncStringEntity6} блок значений
   ...
   */
  static S5HistDataSyncStringEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity6 blob = new S5HistDataSyncStringBlobEntity6( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity6( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity6() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity6} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity6( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity6 blob = new S5HistDataSyncStringBlobEntity6( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity6( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity6( aResultSet );
  }
