 ...
 */
@Entity
public class S5HistDataSyncTimestampBlobEntity4
    extends S5SequenceSyncBlob<S5HistDataSyncTimestampEntity4, long[], long[]> {
   ...
   */
  protected S5HistDataSyncTimestampBlobEntity4() {
  }
   ...
   */
  S5HistDataSyncTimestampBlobEntity4( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncTimestampBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
