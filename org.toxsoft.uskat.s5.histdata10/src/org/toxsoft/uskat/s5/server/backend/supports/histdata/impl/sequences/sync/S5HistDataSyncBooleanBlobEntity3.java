 ...
 */
@Entity
public class S5HistDataSyncBooleanBlobEntity3
    extends S5SequenceSyncBlob<S5HistDataSyncBooleanEntity3, byte[], byte[]> {
   ...
   */
  protected S5HistDataSyncBooleanBlobEntity3() {
  }
   ...
   */
  S5HistDataSyncBooleanBlobEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
