 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity0
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity0, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity0() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity0( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
