 ...
 */
@Entity
public class S5HistDataSyncBooleanBlobEntity1
    extends S5SequenceSyncBlob<S5HistDataSyncBooleanEntity1, byte[], byte[]> {
   ...
   */
  protected S5HistDataSyncBooleanBlobEntity1() {
  }
   ...
   */
  S5HistDataSyncBooleanBlobEntity1( byte[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncBooleanBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
