 ...
 */
@Entity
public class S5HistDataSyncTimestampBlobEntity2
    extends S5SequenceSyncBlob<S5HistDataSyncTimestampEntity2, long[], long[]> {
   ...
   */
  protected S5HistDataSyncTimestampBlobEntity2() {
  }
   ...
   */
  S5HistDataSyncTimestampBlobEntity2( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncTimestampBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
