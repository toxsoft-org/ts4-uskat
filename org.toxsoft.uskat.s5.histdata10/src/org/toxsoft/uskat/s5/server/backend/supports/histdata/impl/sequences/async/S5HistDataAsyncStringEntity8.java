 ...
 */
@Entity
public class S5HistDataAsyncStringEntity8
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity8> {
   ...
   * @return {@link S5HistDataAsyncStringEntity8} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity8 blob = new S5HistDataAsyncStringBlobEntity8( timestamps, values );
    return new S5HistDataAsyncStringEntity8( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity8() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity8} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity8( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity8 blob = new S5HistDataAsyncStringBlobEntity8( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity8( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity8( aResultSet );
  }
