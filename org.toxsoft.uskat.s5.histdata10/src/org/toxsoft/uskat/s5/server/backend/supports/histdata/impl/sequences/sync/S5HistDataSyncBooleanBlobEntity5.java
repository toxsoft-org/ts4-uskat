 ...
 */
@Entity
public class S5HistDataSyncBooleanBlobEntity5
    extends S5SequenceSyncBlob<S5HistDataSyncBooleanEntity5, byte[], byte[]> {
   ...
   */
  protected S5HistDataSyncBooleanBlobEntity5() {
  }
   ...
   */
  S5HistDataSyncBooleanBlobEntity5( byte[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncBooleanBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
