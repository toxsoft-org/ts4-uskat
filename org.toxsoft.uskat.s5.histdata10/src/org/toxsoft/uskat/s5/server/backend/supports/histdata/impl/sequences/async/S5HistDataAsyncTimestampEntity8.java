 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity8
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity8> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity8} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity8 blob = new S5HistDataAsyncTimestampBlobEntity8( timestamps, values );
    return new S5HistDataAsyncTimestampEntity8( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity8() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity8} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity8( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity8 blob = new S5HistDataAsyncTimestampBlobEntity8( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity8( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity8( aResultSet );
  }
