 ...
 */
@Entity
public class S5HistDataSyncStringEntity3
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity3> {
   ...
   * @return {@link S5HistDataSyncStringEntity3} блок значений
   ...
   */
  static S5HistDataSyncStringEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity3 blob = new S5HistDataSyncStringBlobEntity3( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity3( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity3() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity3} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity3( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity3 blob = new S5HistDataSyncStringBlobEntity3( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity3( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity3( aResultSet );
  }
