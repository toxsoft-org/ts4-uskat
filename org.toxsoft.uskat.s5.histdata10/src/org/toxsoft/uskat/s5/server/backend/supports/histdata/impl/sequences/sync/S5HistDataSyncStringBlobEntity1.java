 ...
 */
@Entity
public class S5HistDataSyncStringBlobEntity1
    extends S5SequenceSyncBlob<S5HistDataSyncStringEntity1, String[], String[]> {
   ...
   */
  protected S5HistDataSyncStringBlobEntity1() {
  }
   ...
   */
  S5HistDataSyncStringBlobEntity1( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncStringBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
