 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity7
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity7> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity7} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity7 blob = new S5HistDataSyncIntegerBlobEntity7( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity7( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity7() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity7} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity7( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity7 blob = new S5HistDataSyncIntegerBlobEntity7( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity7( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity7( aResultSet );
  }
