...
public class S5HistDataSyncIntegerEntity7
  ...
  static S5HistDataSyncIntegerEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity7 blob = new S5HistDataSyncIntegerBlobEntity7( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity7 blob = new S5HistDataSyncIntegerBlobEntity7( aValues );
