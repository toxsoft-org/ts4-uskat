 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity8
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity8> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity8} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity8 blob = new S5HistDataSyncIntegerBlobEntity8( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity8( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity8() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity8} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity8( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity8 blob = new S5HistDataSyncIntegerBlobEntity8( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity8( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity8( aResultSet );
  }
