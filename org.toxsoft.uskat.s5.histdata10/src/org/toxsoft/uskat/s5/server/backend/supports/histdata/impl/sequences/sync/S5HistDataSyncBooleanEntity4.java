 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity4
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity4> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity4} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity4 blob = new S5HistDataSyncBooleanBlobEntity4( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity4( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity4() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity4} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity4( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity4 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity4 blob = new S5HistDataSyncBooleanBlobEntity4( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity4( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity4 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity4( aResultSet );
  }
