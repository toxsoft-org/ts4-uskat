...
public class S5HistDataSyncBooleanEntity4
  ...
  static S5HistDataSyncBooleanEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity4 blob = new S5HistDataSyncBooleanBlobEntity4( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity4 blob = new S5HistDataSyncBooleanBlobEntity4( aValues );
