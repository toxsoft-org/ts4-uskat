...
public class S5HistDataSyncBooleanEntity3
  ...
  static S5HistDataSyncBooleanEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity3 blob = new S5HistDataSyncBooleanBlobEntity3( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity3 blob = new S5HistDataSyncBooleanBlobEntity3( aValues );
