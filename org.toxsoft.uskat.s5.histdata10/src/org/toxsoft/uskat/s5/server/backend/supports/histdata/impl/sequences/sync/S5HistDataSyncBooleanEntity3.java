 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity3
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity3> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity3} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity3 blob = new S5HistDataSyncBooleanBlobEntity3( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity3( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity3() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity3} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity3( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity3 blob = new S5HistDataSyncBooleanBlobEntity3( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity3( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity3( aResultSet );
  }
