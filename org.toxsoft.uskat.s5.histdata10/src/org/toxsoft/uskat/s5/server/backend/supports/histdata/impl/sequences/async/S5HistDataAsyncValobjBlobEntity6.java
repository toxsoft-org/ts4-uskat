 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity6
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity6, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity6() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity6( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
