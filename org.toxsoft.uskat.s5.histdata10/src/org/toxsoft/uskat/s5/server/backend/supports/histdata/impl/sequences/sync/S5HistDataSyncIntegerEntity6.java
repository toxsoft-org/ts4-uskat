 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity6
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity6> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity6} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity6 blob = new S5HistDataSyncIntegerBlobEntity6( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity6( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity6() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity6} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity6( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity6 blob = new S5HistDataSyncIntegerBlobEntity6( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity6( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity6( aResultSet );
  }
