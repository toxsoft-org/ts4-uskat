...
public class S5HistDataSyncIntegerEntity6
  ...
  static S5HistDataSyncIntegerEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity6 blob = new S5HistDataSyncIntegerBlobEntity6( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity6 blob = new S5HistDataSyncIntegerBlobEntity6( aValues );
