 ...
 */
@Entity
public class S5HistDataAsyncStringBlobEntity1
    extends S5SequenceAsyncBlob<S5HistDataAsyncStringEntity1, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncStringBlobEntity1() {
  }
   ...
   */
  S5HistDataAsyncStringBlobEntity1( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncStringBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
