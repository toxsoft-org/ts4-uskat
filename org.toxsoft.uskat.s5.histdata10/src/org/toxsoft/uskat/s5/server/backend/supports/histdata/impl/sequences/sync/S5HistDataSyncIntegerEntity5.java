 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity5
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity5> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity5} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity5 blob = new S5HistDataSyncIntegerBlobEntity5( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity5( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity5() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity5} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity5( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity5 blob = new S5HistDataSyncIntegerBlobEntity5( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity5( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity5( aResultSet );
  }
