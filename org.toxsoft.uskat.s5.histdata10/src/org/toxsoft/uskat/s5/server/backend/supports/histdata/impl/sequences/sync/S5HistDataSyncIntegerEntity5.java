...
public class S5HistDataSyncIntegerEntity5
  ...
  static S5HistDataSyncIntegerEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity5 blob = new S5HistDataSyncIntegerBlobEntity5( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity5 blob = new S5HistDataSyncIntegerBlobEntity5( aValues );
