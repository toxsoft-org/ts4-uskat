...
public class S5HistDataSyncStringEntity5
  ...
  static S5HistDataSyncStringEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity5 blob = new S5HistDataSyncStringBlobEntity5( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncStringBlobEntity5 blob = new S5HistDataSyncStringBlobEntity5( aValues );
