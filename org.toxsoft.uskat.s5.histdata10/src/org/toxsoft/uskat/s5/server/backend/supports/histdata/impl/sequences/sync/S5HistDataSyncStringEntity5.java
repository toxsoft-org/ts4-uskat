 ...
 */
@Entity
public class S5HistDataSyncStringEntity5
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity5> {
   ...
   * @return {@link S5HistDataSyncStringEntity5} блок значений
   ...
   */
  static S5HistDataSyncStringEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity5 blob = new S5HistDataSyncStringBlobEntity5( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity5( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity5() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity5} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity5( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity5 blob = new S5HistDataSyncStringBlobEntity5( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity5( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity5( aResultSet );
  }
