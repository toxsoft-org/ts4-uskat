 ...
 */
@Entity
public class S5HistDataSyncTimestampBlobEntity1
    extends S5SequenceSyncBlob<S5HistDataSyncTimestampEntity1, long[], long[]> {
   ...
   */
  protected S5HistDataSyncTimestampBlobEntity1() {
  }
   ...
   */
  S5HistDataSyncTimestampBlobEntity1( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncTimestampBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
