 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity2
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity2> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity2} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity2 blob = new S5HistDataAsyncBooleanBlobEntity2( timestamps, values );
    return new S5HistDataAsyncBooleanEntity2( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity2() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity2} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity2( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity2 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity2 blob = new S5HistDataAsyncBooleanBlobEntity2( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity2( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity2 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity2( aResultSet );
  }
