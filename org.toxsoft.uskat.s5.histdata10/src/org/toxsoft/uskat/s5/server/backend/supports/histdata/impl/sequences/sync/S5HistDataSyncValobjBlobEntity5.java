 ...
 */
@Entity
public class S5HistDataSyncValobjBlobEntity5
    extends S5SequenceSyncBlob<S5HistDataSyncValobjEntity5, String[], String[]> {
   ...
   */
  protected S5HistDataSyncValobjBlobEntity5() {
  }
   ...
   */
  S5HistDataSyncValobjBlobEntity5( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncValobjBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
