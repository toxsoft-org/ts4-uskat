 ...
 */
@Entity
public class S5HistDataSyncIntegerBlobEntity6
    extends S5SequenceSyncBlob<S5HistDataSyncIntegerEntity6, long[], long[]> {
   ...
   */
  protected S5HistDataSyncIntegerBlobEntity6() {
  }
   ...
   */
  S5HistDataSyncIntegerBlobEntity6( long[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncIntegerBlobEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
