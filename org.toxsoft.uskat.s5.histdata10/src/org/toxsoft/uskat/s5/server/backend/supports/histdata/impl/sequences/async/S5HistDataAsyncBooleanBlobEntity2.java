 ...
 */
@Entity
public class S5HistDataAsyncBooleanBlobEntity2
    extends S5SequenceAsyncBlob<S5HistDataAsyncBooleanEntity2, byte[], byte[]> {
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity2() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity2( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
