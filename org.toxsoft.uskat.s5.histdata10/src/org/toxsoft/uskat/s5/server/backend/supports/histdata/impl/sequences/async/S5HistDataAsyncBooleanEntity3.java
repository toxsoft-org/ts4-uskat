 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity3
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity3> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity3} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity3 blob = new S5HistDataAsyncBooleanBlobEntity3( timestamps, values );
    return new S5HistDataAsyncBooleanEntity3( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity3() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity3} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity3( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity3 blob = new S5HistDataAsyncBooleanBlobEntity3( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity3( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity3( aResultSet );
  }
