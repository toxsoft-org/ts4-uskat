 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity8
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity8> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity8} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity8 blob = new S5HistDataSyncBooleanBlobEntity8( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity8( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity8() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity8} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity8( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long aEndTime, byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity8 blob = new S5HistDataSyncBooleanBlobEntity8( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity8( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity8( aResultSet );
  }
