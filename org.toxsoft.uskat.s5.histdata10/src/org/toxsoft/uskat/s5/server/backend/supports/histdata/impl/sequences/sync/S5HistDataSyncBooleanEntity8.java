...
public class S5HistDataSyncBooleanEntity8
  ...
  static S5HistDataSyncBooleanEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity8 blob = new S5HistDataSyncBooleanBlobEntity8( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity8 blob = new S5HistDataSyncBooleanBlobEntity8( aValues );
