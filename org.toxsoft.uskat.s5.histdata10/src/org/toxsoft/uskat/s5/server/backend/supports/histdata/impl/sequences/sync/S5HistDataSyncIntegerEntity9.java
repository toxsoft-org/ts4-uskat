 ...
 */
@Entity
public class S5HistDataSyncIntegerEntity9
    extends S5HistDataSyncBlock<long[], S5HistDataSyncIntegerBlobEntity9> {
   ...
   * @return {@link S5HistDataSyncIntegerEntity9} блок значений
   ...
   */
  static S5HistDataSyncIntegerEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity9 blob = new S5HistDataSyncIntegerBlobEntity9( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncIntegerEntity9( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncIntegerEntity9() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncIntegerBlobEntity9} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncIntegerEntity9( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncIntegerBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataSyncIntegerEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncIntegerBlobEntity9 blob = new S5HistDataSyncIntegerBlobEntity9( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncIntegerEntity9( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncIntegerBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncIntegerBlobEntity9( aResultSet );
  }
