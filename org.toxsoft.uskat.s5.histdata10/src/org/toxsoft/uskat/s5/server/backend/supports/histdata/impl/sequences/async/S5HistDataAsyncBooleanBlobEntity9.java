 ...
 */
@Entity
public class S5HistDataAsyncBooleanBlobEntity9
    extends S5SequenceAsyncBlob<S5HistDataAsyncBooleanEntity9, byte[], byte[]> {
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity9() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity9( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
