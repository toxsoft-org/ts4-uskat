...
public class S5HistDataSyncBooleanEntity5
  ...
  static S5HistDataSyncBooleanEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity5 blob = new S5HistDataSyncBooleanBlobEntity5( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity5 blob = new S5HistDataSyncBooleanBlobEntity5( aValues );
