 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity5
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity5> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity5} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity5 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity5 blob = new S5HistDataSyncBooleanBlobEntity5( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity5( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity5() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity5} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity5( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity5 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity5 blob = new S5HistDataSyncBooleanBlobEntity5( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity5( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity5 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity5( aResultSet );
  }
