 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity5
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity5, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity5() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity5( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
