 ...
 */
@Entity
public class S5HistDataAsyncTimestampBlobEntity6
    extends S5SequenceAsyncBlob<S5HistDataAsyncTimestampEntity6, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity6() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity6( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
