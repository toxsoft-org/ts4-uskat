 ...
 */
@Entity
public class S5HistDataSyncStringEntity9
    extends S5HistDataSyncBlock<String[], S5HistDataSyncStringBlobEntity9> {
   ...
   * @return {@link S5HistDataSyncStringEntity9} блок значений
   ...
   */
  static S5HistDataSyncStringEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity9 blob = new S5HistDataSyncStringBlobEntity9( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncStringEntity9( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncStringEntity9() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncStringBlobEntity9} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncStringEntity9( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncStringBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataSyncStringEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncStringBlobEntity9 blob = new S5HistDataSyncStringBlobEntity9( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncStringEntity9( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncStringBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncStringBlobEntity9( aResultSet );
  }
