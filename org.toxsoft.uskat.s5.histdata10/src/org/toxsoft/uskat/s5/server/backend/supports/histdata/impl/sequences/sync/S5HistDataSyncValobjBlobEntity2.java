 ...
 */
@Entity
public class S5HistDataSyncValobjBlobEntity2
    extends S5SequenceSyncBlob<S5HistDataSyncValobjEntity2, String[], String[]> {
   ...
   */
  protected S5HistDataSyncValobjBlobEntity2() {
  }
   ...
   */
  S5HistDataSyncValobjBlobEntity2( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncValobjBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
