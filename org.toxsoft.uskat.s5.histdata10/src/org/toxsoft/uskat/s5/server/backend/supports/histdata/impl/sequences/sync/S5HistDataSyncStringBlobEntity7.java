 ...
 */
@Entity
public class S5HistDataSyncStringBlobEntity7
    extends S5SequenceSyncBlob<S5HistDataSyncStringEntity7, String[], String[]> {
   ...
   */
  protected S5HistDataSyncStringBlobEntity7() {
  }
   ...
   */
  S5HistDataSyncStringBlobEntity7( String[] aValues, long aEndTime ) {
   ...
   */
  S5HistDataSyncStringBlobEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
