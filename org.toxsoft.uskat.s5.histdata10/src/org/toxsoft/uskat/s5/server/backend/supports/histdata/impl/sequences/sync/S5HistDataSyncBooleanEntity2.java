 ...
 */
@Entity
public class S5HistDataSyncBooleanEntity2
    extends S5HistDataSyncBlock<byte[], S5HistDataSyncBooleanBlobEntity2> {
   ...
   * @return {@link S5HistDataSyncBooleanEntity2} блок значений
   ...
   */
  static S5HistDataSyncBooleanEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity2 blob = new S5HistDataSyncBooleanBlobEntity2( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncBooleanEntity2( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncBooleanEntity2() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncBooleanBlobEntity2} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncBooleanEntity2( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncBooleanBlobEntity2 aBlob ) {
   ...
   */
  S5HistDataSyncBooleanEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncBooleanBlobEntity2 blob = new S5HistDataSyncBooleanBlobEntity2( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncBooleanEntity2( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncBooleanBlobEntity2 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncBooleanBlobEntity2( aResultSet );
  }
