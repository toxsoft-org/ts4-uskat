...
public class S5HistDataSyncTimestampEntity1
  ...
  static S5HistDataSyncTimestampEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity1 blob = new S5HistDataSyncTimestampBlobEntity1( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncTimestampBlobEntity1 blob = new S5HistDataSyncTimestampBlobEntity1( aValues );
