 ...
 */
@Entity
public class S5HistDataSyncTimestampEntity1
    extends S5HistDataSyncBlock<long[], S5HistDataSyncTimestampBlobEntity1> {
   ...
   * @return {@link S5HistDataSyncTimestampEntity1} блок значений
   ...
   */
  static S5HistDataSyncTimestampEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity1 blob = new S5HistDataSyncTimestampBlobEntity1( values, Long.valueOf( endTime ) );
    return new S5HistDataSyncTimestampEntity1( aTypeInfo, aGwid, startTime, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataSyncTimestampEntity1() {
  }
   ...
   * @param aBlob {@link S5HistDataSyncTimestampBlobEntity1} реализация blob-а в котором хранятся значения блока
   * @throws TsNullArgumentRtException любой аргумент = null
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   * @throws TsIllegalArgumentRtException описание данного должно представлять синхронное данное
   */
  S5HistDataSyncTimestampEntity1( IParameterized aTypeInfo, Gwid aGwid, long aStartTime,
      S5HistDataSyncTimestampBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataSyncTimestampEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected IS5SequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
    ...
    S5HistDataSyncTimestampBlobEntity1 blob =
        new S5HistDataSyncTimestampBlobEntity1( aValues, Long.valueOf( aEndTime ) );
    return new S5HistDataSyncTimestampEntity1( aTypeInfo, gwid(), aStartTime, blob );
  }

  @Override
  protected S5HistDataSyncTimestampBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataSyncTimestampBlobEntity1( aResultSet );
  }
