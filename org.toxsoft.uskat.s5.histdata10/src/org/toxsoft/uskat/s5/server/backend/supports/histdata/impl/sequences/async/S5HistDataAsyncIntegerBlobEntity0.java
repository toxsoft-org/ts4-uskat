 ...
 */
@Entity
public class S5HistDataAsyncIntegerBlobEntity0
    extends S5SequenceAsyncBlob<S5HistDataAsyncIntegerEntity0, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncIntegerBlobEntity0() {
  }
   ...
   */
  S5HistDataAsyncIntegerBlobEntity0( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncIntegerBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
