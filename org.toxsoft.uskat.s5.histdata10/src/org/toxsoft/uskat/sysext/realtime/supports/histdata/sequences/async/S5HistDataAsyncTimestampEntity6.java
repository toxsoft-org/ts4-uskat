 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity6
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity6> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity6} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity6 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity6 blob = new S5HistDataAsyncTimestampBlobEntity6( timestamps, values );
    return new S5HistDataAsyncTimestampEntity6( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity6() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity6} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity6( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity6 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity6 blob = new S5HistDataAsyncTimestampBlobEntity6( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity6( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity6 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity6( aResultSet );
  }
