 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity0
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity0> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity0} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity0 blob = new S5HistDataAsyncBooleanBlobEntity0( timestamps, values );
    return new S5HistDataAsyncBooleanEntity0( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity0() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity0} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity0( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity0 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity0 blob = new S5HistDataAsyncBooleanBlobEntity0( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity0( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity0 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity0( aResultSet );
  }
