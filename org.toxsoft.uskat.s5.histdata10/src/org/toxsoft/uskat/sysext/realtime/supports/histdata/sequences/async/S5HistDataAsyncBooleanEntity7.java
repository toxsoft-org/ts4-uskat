 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity7
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity7> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity7} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity7 blob = new S5HistDataAsyncBooleanBlobEntity7( timestamps, values );
    return new S5HistDataAsyncBooleanEntity7( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity7() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity7} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity7( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity7 blob = new S5HistDataAsyncBooleanBlobEntity7( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity7( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity7( aResultSet );
  }
