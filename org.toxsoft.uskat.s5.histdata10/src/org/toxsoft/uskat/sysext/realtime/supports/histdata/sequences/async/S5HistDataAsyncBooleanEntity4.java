 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity4
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity4> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity4} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity4 blob = new S5HistDataAsyncBooleanBlobEntity4( timestamps, values );
    return new S5HistDataAsyncBooleanEntity4( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity4() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity4} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity4( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity4 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity4 blob = new S5HistDataAsyncBooleanBlobEntity4( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity4( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity4 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity4( aResultSet );
  }
