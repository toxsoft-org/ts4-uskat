...
public class S5HistDataAsyncTimestampBlobEntity9
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity9() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity9( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
