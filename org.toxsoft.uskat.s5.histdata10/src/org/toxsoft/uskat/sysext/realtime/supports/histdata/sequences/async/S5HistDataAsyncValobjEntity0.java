 ...
 */
@Entity
public class S5HistDataAsyncValobjEntity0
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncValobjBlobEntity0> {
   ...
   * @return {@link S5HistDataAsyncValobjEntity0} блок значений
   ...
   */
  static S5HistDataAsyncValobjEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncValobjBlobEntity0 blob = new S5HistDataAsyncValobjBlobEntity0( timestamps, values );
    return new S5HistDataAsyncValobjEntity0( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncValobjEntity0() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncValobjBlobEntity0} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncValobjEntity0( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncValobjBlobEntity0 aBlob ) {
   ...
   */
  S5HistDataAsyncValobjEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncValobjBlobEntity0 blob = new S5HistDataAsyncValobjBlobEntity0( aTimestamps, aValues );
    return new S5HistDataAsyncValobjEntity0( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncValobjBlobEntity0 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncValobjBlobEntity0( aResultSet );
  }
