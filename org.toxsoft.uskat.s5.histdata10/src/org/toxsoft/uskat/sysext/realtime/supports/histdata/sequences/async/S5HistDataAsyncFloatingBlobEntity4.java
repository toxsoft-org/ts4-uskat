 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity4
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity4, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity4() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity4( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
