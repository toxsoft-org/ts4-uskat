...
public class S5HistDataSyncStringEntity9
  ...
  static S5HistDataSyncStringEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncStringBlobEntity9 blob = new S5HistDataSyncStringBlobEntity9( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      String[] aValues ) {
    S5HistDataSyncStringBlobEntity9 blob = new S5HistDataSyncStringBlobEntity9( aValues );
