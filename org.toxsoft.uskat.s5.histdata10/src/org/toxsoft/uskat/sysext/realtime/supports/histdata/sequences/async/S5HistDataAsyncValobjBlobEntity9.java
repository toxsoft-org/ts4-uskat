 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity9
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity9, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity9() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity9( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
