 ...
 */
@Entity
public class S5HistDataAsyncValobjEntity7
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncValobjBlobEntity7> {
   ...
   * @return {@link S5HistDataAsyncValobjEntity7} блок значений
   ...
   */
  static S5HistDataAsyncValobjEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncValobjBlobEntity7 blob = new S5HistDataAsyncValobjBlobEntity7( timestamps, values );
    return new S5HistDataAsyncValobjEntity7( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncValobjEntity7() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncValobjBlobEntity7} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncValobjEntity7( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncValobjBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataAsyncValobjEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncValobjBlobEntity7 blob = new S5HistDataAsyncValobjBlobEntity7( aTimestamps, aValues );
    return new S5HistDataAsyncValobjEntity7( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncValobjBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncValobjBlobEntity7( aResultSet );
  }
