 ...
 */
@Entity
public class S5HistDataAsyncIntegerBlobEntity5
    extends S5SequenceAsyncBlob<S5HistDataAsyncIntegerEntity5, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncIntegerBlobEntity5() {
  }
   ...
   */
  S5HistDataAsyncIntegerBlobEntity5( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncIntegerBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
