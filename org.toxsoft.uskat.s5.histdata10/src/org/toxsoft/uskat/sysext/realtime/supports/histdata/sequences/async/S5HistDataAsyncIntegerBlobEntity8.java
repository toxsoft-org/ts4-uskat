 ...
 */
@Entity
public class S5HistDataAsyncIntegerBlobEntity8
    extends S5SequenceAsyncBlob<S5HistDataAsyncIntegerEntity8, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncIntegerBlobEntity8() {
  }
   ...
   */
  S5HistDataAsyncIntegerBlobEntity8( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncIntegerBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
