 ...
 */
@Entity
public class S5HistDataAsyncBooleanBlobEntity5
    extends S5SequenceAsyncBlob<S5HistDataAsyncBooleanEntity5, byte[], byte[]> {
   ...
   */
  protected S5HistDataAsyncBooleanBlobEntity5() {
  }
   ...
   */
  S5HistDataAsyncBooleanBlobEntity5( long[] aTimestamps, byte[] aValues ) {
   ...
   */
  S5HistDataAsyncBooleanBlobEntity5( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
