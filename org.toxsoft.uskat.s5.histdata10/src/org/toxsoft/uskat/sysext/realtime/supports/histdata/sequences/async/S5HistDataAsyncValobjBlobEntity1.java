 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity1
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity1, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity1() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity1( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
