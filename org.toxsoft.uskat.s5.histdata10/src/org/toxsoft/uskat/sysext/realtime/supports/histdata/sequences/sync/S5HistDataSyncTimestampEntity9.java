...
public class S5HistDataSyncTimestampEntity9
  ...
  static S5HistDataSyncTimestampEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity9 blob = new S5HistDataSyncTimestampBlobEntity9( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncTimestampBlobEntity9 blob = new S5HistDataSyncTimestampBlobEntity9( aValues );
