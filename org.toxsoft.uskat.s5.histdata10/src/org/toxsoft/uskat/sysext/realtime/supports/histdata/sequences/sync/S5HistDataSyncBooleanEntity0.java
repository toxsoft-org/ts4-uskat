...
public class S5HistDataSyncBooleanEntity0
  ...
  static S5HistDataSyncBooleanEntity0 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity0 blob = new S5HistDataSyncBooleanBlobEntity0( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity0 blob = new S5HistDataSyncBooleanBlobEntity0( aValues );
