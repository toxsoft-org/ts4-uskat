...
public class S5HistDataSyncFloatingEntity3
  ...
  static S5HistDataSyncFloatingEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity3 blob = new S5HistDataSyncFloatingBlobEntity3( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      double[] aValues ) {
    S5HistDataSyncFloatingBlobEntity3 blob = new S5HistDataSyncFloatingBlobEntity3( aValues );
