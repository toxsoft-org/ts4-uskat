 ...
 */
@Entity
public class S5HistDataAsyncTimestampBlobEntity1
    extends S5SequenceAsyncBlob<S5HistDataAsyncTimestampEntity1, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity1() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity1( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
