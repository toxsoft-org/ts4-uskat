 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity2
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity2, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity2() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity2( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
