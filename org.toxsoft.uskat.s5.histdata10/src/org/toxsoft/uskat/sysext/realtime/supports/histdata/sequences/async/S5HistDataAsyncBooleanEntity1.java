 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity1
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity1> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity1} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity1 blob = new S5HistDataAsyncBooleanBlobEntity1( timestamps, values );
    return new S5HistDataAsyncBooleanEntity1( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity1() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity1} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity1( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      byte[] aValues ) {
    S5HistDataAsyncBooleanBlobEntity1 blob = new S5HistDataAsyncBooleanBlobEntity1( aTimestamps, aValues );
    return new S5HistDataAsyncBooleanEntity1( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncBooleanBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity1( aResultSet );
  }
