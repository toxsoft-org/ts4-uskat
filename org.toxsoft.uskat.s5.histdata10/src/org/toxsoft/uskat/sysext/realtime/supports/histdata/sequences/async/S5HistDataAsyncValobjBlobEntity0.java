 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity0
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity0, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity0() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity0( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
