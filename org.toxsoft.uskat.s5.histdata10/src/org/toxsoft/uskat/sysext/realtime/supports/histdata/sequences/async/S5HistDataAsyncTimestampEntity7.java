 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity7
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity7> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity7} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity7 blob = new S5HistDataAsyncTimestampBlobEntity7( timestamps, values );
    return new S5HistDataAsyncTimestampEntity7( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity7() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity7} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity7( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity7 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity7( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity7 blob = new S5HistDataAsyncTimestampBlobEntity7( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity7( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity7 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity7( aResultSet );
  }
