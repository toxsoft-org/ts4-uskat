 ...
 */
@Entity
public class S5HistDataAsyncValobjEntity9
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncValobjBlobEntity9> {
   ...
   * @return {@link S5HistDataAsyncValobjEntity9} блок значений
   ...
   */
  static S5HistDataAsyncValobjEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncValobjBlobEntity9 blob = new S5HistDataAsyncValobjBlobEntity9( timestamps, values );
    return new S5HistDataAsyncValobjEntity9( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncValobjEntity9() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncValobjBlobEntity9} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncValobjEntity9( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncValobjBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataAsyncValobjEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncValobjBlobEntity9 blob = new S5HistDataAsyncValobjBlobEntity9( aTimestamps, aValues );
    return new S5HistDataAsyncValobjEntity9( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncValobjBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncValobjBlobEntity9( aResultSet );
  }
