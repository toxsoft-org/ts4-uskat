 ...
 */
@Entity
public class S5HistDataAsyncTimestampEntity3
    extends S5HistDataAsyncBlock<long[], S5HistDataAsyncTimestampBlobEntity3> {
   ...
   * @return {@link S5HistDataAsyncTimestampEntity3} блок значений
   ...
   */
  static S5HistDataAsyncTimestampEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncTimestampBlobEntity3 blob = new S5HistDataAsyncTimestampBlobEntity3( timestamps, values );
    return new S5HistDataAsyncTimestampEntity3( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncTimestampEntity3() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncTimestampBlobEntity3} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncTimestampEntity3( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncTimestampBlobEntity3 aBlob ) {
   ...
   */
  S5HistDataAsyncTimestampEntity3( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      long[] aValues ) {
    S5HistDataAsyncTimestampBlobEntity3 blob = new S5HistDataAsyncTimestampBlobEntity3( aTimestamps, aValues );
    return new S5HistDataAsyncTimestampEntity3( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncTimestampBlobEntity3 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncTimestampBlobEntity3( aResultSet );
  }
