 ...
 */
@Entity
public class S5HistDataAsyncStringEntity9
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity9> {
   ...
   * @return {@link S5HistDataAsyncStringEntity9} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity9 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity9 blob = new S5HistDataAsyncStringBlobEntity9( timestamps, values );
    return new S5HistDataAsyncStringEntity9( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity9() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity9} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity9( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity9 aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity9( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity9 blob = new S5HistDataAsyncStringBlobEntity9( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity9( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity9 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity9( aResultSet );
  }
