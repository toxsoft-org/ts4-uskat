 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity8
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity8, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity8() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity8( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
