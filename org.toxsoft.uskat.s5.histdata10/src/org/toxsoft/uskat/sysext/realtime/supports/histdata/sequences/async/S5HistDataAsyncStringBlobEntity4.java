 ...
 */
@Entity
public class S5HistDataAsyncStringBlobEntity4
    extends S5SequenceAsyncBlob<S5HistDataAsyncStringEntity4, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncStringBlobEntity4() {
  }
   ...
   */
  S5HistDataAsyncStringBlobEntity4( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncStringBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
