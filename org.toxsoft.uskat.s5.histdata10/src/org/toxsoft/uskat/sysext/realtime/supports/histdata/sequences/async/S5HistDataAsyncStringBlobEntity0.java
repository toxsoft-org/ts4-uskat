 ...
 */
@Entity
public class S5HistDataAsyncStringBlobEntity0
    extends S5SequenceAsyncBlob<S5HistDataAsyncStringEntity0, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncStringBlobEntity0() {
  }
   ...
   */
  S5HistDataAsyncStringBlobEntity0( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncStringBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
