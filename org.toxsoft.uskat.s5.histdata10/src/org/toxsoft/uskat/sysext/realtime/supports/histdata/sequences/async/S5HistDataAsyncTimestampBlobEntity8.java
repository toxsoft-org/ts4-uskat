 ...
 */
@Entity
public class S5HistDataAsyncTimestampBlobEntity8
    extends S5SequenceAsyncBlob<S5HistDataAsyncTimestampEntity8, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity8() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity8( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
