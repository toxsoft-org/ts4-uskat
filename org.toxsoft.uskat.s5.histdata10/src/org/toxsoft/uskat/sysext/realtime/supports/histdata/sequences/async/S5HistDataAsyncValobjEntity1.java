 ...
 */
@Entity
public class S5HistDataAsyncValobjEntity1
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncValobjBlobEntity1> {
   ...
   * @return {@link S5HistDataAsyncValobjEntity1} блок значений
   ...
   */
  static S5HistDataAsyncValobjEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncValobjBlobEntity1 blob = new S5HistDataAsyncValobjBlobEntity1( timestamps, values );
    return new S5HistDataAsyncValobjEntity1( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncValobjEntity1() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncValobjBlobEntity1} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncValobjEntity1( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncValobjBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataAsyncValobjEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncValobjBlobEntity1 blob = new S5HistDataAsyncValobjBlobEntity1( aTimestamps, aValues );
    return new S5HistDataAsyncValobjEntity1( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncValobjBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncValobjBlobEntity1( aResultSet );
  }
