...
public class S5HistDataSyncIntegerEntity3
  ...
  static S5HistDataSyncIntegerEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity3 blob = new S5HistDataSyncIntegerBlobEntity3( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity3 blob = new S5HistDataSyncIntegerBlobEntity3( aValues );
