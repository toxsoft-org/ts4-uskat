 ...
 */
@Entity
public class S5HistDataAsyncIntegerBlobEntity2
    extends S5SequenceAsyncBlob<S5HistDataAsyncIntegerEntity2, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncIntegerBlobEntity2() {
  }
   ...
   */
  S5HistDataAsyncIntegerBlobEntity2( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncIntegerBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
