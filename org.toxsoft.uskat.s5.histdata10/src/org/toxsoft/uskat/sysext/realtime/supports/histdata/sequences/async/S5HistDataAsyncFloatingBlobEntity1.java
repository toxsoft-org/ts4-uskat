 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity1
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity1, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity1() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity1( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
