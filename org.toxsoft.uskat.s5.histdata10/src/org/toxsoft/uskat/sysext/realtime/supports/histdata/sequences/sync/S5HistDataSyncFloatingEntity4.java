...
public class S5HistDataSyncFloatingEntity4
  ...
  static S5HistDataSyncFloatingEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncFloatingBlobEntity4 blob = new S5HistDataSyncFloatingBlobEntity4( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      double[] aValues ) {
    S5HistDataSyncFloatingBlobEntity4 blob = new S5HistDataSyncFloatingBlobEntity4( aValues );
