 ...
 */
@Entity
public class S5HistDataAsyncTimestampBlobEntity0
    extends S5SequenceAsyncBlob<S5HistDataAsyncTimestampEntity0, long[], long[]> {
   ...
   */
  protected S5HistDataAsyncTimestampBlobEntity0() {
  }
   ...
   */
  S5HistDataAsyncTimestampBlobEntity0( long[] aTimestamps, long[] aValues ) {
   ...
   */
  S5HistDataAsyncTimestampBlobEntity0( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
