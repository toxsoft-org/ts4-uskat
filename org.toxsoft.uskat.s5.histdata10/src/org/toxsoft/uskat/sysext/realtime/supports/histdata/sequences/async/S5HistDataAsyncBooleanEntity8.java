 ...
 */
@Entity
public class S5HistDataAsyncBooleanEntity8
    extends S5HistDataAsyncBlock<byte[], S5HistDataAsyncBooleanBlobEntity8> {
   ...
   * @return {@link S5HistDataAsyncBooleanEntity8} блок значений
   ...
   */
  static S5HistDataAsyncBooleanEntity8 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncBooleanBlobEntity8 blob = new S5HistDataAsyncBooleanBlobEntity8( timestamps, values );
    return new S5HistDataAsyncBooleanEntity8( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncBooleanEntity8() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncBooleanBlobEntity8} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncBooleanEntity8( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncBooleanBlobEntity8 aBlob ) {
   ...
   */
  S5HistDataAsyncBooleanEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  @Override
  protected S5HistDataAsyncBooleanBlobEntity8 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncBooleanBlobEntity8( aResultSet );
  }
