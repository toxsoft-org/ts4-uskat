...
public class S5HistDataSyncBooleanEntity7
  ...
  static S5HistDataSyncBooleanEntity7 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncBooleanBlobEntity7 blob = new S5HistDataSyncBooleanBlobEntity7( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      byte[] aValues ) {
    S5HistDataSyncBooleanBlobEntity7 blob = new S5HistDataSyncBooleanBlobEntity7( aValues );
