 ...
 */
@Entity
public class S5HistDataAsyncStringEntity2
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity2> {
   ...
   * @return {@link S5HistDataAsyncStringEntity2} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity2 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity2 blob = new S5HistDataAsyncStringBlobEntity2( timestamps, values );
    return new S5HistDataAsyncStringEntity2( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity2() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity2} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity2( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity2 aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity2 blob = new S5HistDataAsyncStringBlobEntity2( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity2( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity2 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity2( aResultSet );
  }
