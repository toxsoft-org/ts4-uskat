 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity8
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity8, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity8() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity8( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity8( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
