 ...
 */
@Entity
public class S5HistDataAsyncStringBlobEntity2
    extends S5SequenceAsyncBlob<S5HistDataAsyncStringEntity2, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncStringBlobEntity2() {
  }
   ...
   */
  S5HistDataAsyncStringBlobEntity2( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncStringBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
