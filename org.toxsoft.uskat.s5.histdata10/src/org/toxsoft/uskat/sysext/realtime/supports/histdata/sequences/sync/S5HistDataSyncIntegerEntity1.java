...
public class S5HistDataSyncIntegerEntity1
  ...
  static S5HistDataSyncIntegerEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity1 blob = new S5HistDataSyncIntegerBlobEntity1( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity1 blob = new S5HistDataSyncIntegerBlobEntity1( aValues );
