 ...
 */
@Entity
public class S5HistDataAsyncValobjBlobEntity4
    extends S5SequenceAsyncBlob<S5HistDataAsyncValobjEntity4, String[], String[]> {
   ...
   */
  protected S5HistDataAsyncValobjBlobEntity4() {
  }
   ...
   */
  S5HistDataAsyncValobjBlobEntity4( long[] aTimestamps, String[] aValues ) {
   ...
   */
  S5HistDataAsyncValobjBlobEntity4( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
