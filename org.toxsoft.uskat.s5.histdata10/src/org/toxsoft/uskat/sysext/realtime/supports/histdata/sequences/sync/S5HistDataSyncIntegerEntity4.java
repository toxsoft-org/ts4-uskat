...
public class S5HistDataSyncIntegerEntity4
  ...
  static S5HistDataSyncIntegerEntity4 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncIntegerBlobEntity4 blob = new S5HistDataSyncIntegerBlobEntity4( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncIntegerBlobEntity4 blob = new S5HistDataSyncIntegerBlobEntity4( aValues );
