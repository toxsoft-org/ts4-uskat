 ...
 */
@Entity
public class S5HistDataAsyncStringEntity1
    extends S5HistDataAsyncBlock<String[], S5HistDataAsyncStringBlobEntity1> {
   ...
   * @return {@link S5HistDataAsyncStringEntity1} блок значений
   ...
   */
  static S5HistDataAsyncStringEntity1 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataAsyncStringBlobEntity1 blob = new S5HistDataAsyncStringBlobEntity1( timestamps, values );
    return new S5HistDataAsyncStringEntity1( aTypeInfo, aGwid, blob );
  }

  /**
   * Конструктор без параметров (для JPA)
   */
  protected S5HistDataAsyncStringEntity1() {
  }
   ...
   * @param aTypeInfo {@link IParameterized} параметризованное описание типа данного
   * @param aGwid {@link Gwid} НЕабстрактный {@link Gwid}-идентификатор данного
   * @param aBlob {@link S5HistDataAsyncStringBlobEntity1} реализация blob-а в котором хранятся значения блока и их
   *          метки времени
   * @throws TsIllegalArgumentRtException количество значений в блоке = 0
   ...
   * @throws TsIllegalArgumentRtException описание данного должно представлять асинхронное данное
   */
  S5HistDataAsyncStringEntity1( IParameterized aTypeInfo, Gwid aGwid, S5HistDataAsyncStringBlobEntity1 aBlob ) {
   ...
   */
  S5HistDataAsyncStringEntity1( ResultSet aResultSet ) {
    super( aResultSet );
  }
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long[] aTimestamps,
      String[] aValues ) {
    S5HistDataAsyncStringBlobEntity1 blob = new S5HistDataAsyncStringBlobEntity1( aTimestamps, aValues );
    return new S5HistDataAsyncStringEntity1( aTypeInfo, gwid(), blob );
  }

  @Override
  protected S5HistDataAsyncStringBlobEntity1 doCreateBlob( ResultSet aResultSet ) {
    return new S5HistDataAsyncStringBlobEntity1( aResultSet );
  }
