 ...
 */
@Entity
public class S5HistDataSyncFloatingBlobEntity6
    extends S5SequenceSyncBlob<S5HistDataSyncFloatingEntity6, double[], double[]> {
   ...
   */
  protected S5HistDataSyncFloatingBlobEntity6() {
  }
   ...
   */
  S5HistDataSyncFloatingBlobEntity6( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
