...
public class S5HistDataSyncTimestampEntity3
  ...
  static S5HistDataSyncTimestampEntity3 create( IParameterized aTypeInfo, Gwid aGwid,
    ...
    S5HistDataSyncTimestampBlobEntity3 blob = new S5HistDataSyncTimestampBlobEntity3( values );
  ...
  protected ISequenceBlockEdit<ITemporalAtomicValue> doCreateBlock( IParameterized aTypeInfo, long aStartTime,
      long[] aValues ) {
    S5HistDataSyncTimestampBlobEntity3 blob = new S5HistDataSyncTimestampBlobEntity3( aValues );
