 ...
 */
@Entity
public class S5HistDataAsyncFloatingBlobEntity2
    extends S5SequenceAsyncBlob<S5HistDataAsyncFloatingEntity2, double[], double[]> {
   ...
   */
  protected S5HistDataAsyncFloatingBlobEntity2() {
  }
   ...
   */
  S5HistDataAsyncFloatingBlobEntity2( long[] aTimestamps, double[] aValues ) {
   ...
   */
  S5HistDataAsyncFloatingBlobEntity2( ResultSet aResultSet ) {
    super( aResultSet );
  }
}
