...
/**
 * Abstract class is base for all class claiming service validators.
 *
 * @author hazard157
 */
public class AbstractClassClaimingValidator
   ...
   */
  public AbstractClassClaimingValidator( String aServiceId, IList<TextMatcher> aRules ) {
