...
interface ISkResources {
  ...
  String FMT_ERR_UNEXPECTED_TESTING       = Messages.getString( "FMT_ERR_UNEXPECTED_TESTING" );
   ...
   */
  String FMT_ERR_QUERY_IS_ALREADY_CLOSED = Messages.getString( "FMT_ERR_QUERY_IS_ALREADY_CLOSED" );
   ...
   * {@link SkWorkerBase}
   */
  String FMT_INFO_DOJOB_STAT        = Messages.getString( "FMT_INFO_DOJOB_STAT" );
  String FMT_INFO_CURRDATA_RECEVIED = Messages.getString( "FMT_INFO_CURRDATA_RECEVIED" );

  /**
   * AbstractDtoObjectManager
   */
  String ERR_OBJ_ALREADY_REMOVED = Messages.getString( "ERR_OBJ_ALREADY_REMOVED" );
  String ERR_OBJ_ALREADY_EXIST   = Messages.getString( "ERR_OBJ_ALREADY_EXIST" );
  String ERR_OBJ_NOT_FOUND       = Messages.getString( "ERR_OBJ_NOT_FOUND" );
  ...
  String FMT_ERR_RR_FIXME_WAAT_IS_THIS_ERROR = Messages.getString( "FMT_ERR_RR_ROBJ_ALREADY_EXISTS" );

  String FMT_ERR_RR_ROBJ_NOT_FOUND         = Messages.getString( "ERR_RR_ROBJ_NOT_FOUND" );
  String FMT_ERR_RR_LOBJ_NOT_FOUND         = Messages.getString( "FMT_ERR_RR_LOBJ_NOT_FOUND" );
  String FMT_ERR_RR_EDITOR_CLASS_NOT_FOUND = Messages.getString( "FMT_ERR_RR_EDITOR_CLASS_NOT_FOUND" );
  String FMT_ERR_RR_EDITOR_RIVET_NOT_FOUND = Messages.getString( "FMT_ERR_RR_EDITOR_RIVET_NOT_FOUND" );
}
