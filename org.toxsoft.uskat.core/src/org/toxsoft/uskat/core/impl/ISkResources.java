...
interface ISkResources {
  ...
  String STR_REF_PROGRESS_CALLBACK      = Messages.getString( "STR_REF_PROGRESS_CALLBACK" );      //$NON-NLS-1$
  String STR_REF_PROGRESS_CALLBACK_D    = Messages.getString( "STR_REF_PROGRESS_CALLBACK_D" );    //$NON-NLS-1$
  ...
  String FMT_WARN_UNHANDLED_BACKEND_MESSAGE = Messages.getString( "FMT_WARN_UNHANDLED_BACKEND_MESSAGE" ); //$NON-NLS-1$
  String FMT_MSG_INIT_SERVICE               = Messages.getString( "FMT_MSG_INIT_SERVICE" );               //$NON-NLS-1$
  String FMT_MSG_INIT_HANDLER               = Messages.getString( "MSG_INIT_HANDLER" );                   //$NON-NLS-1$
  String FMT_MSG_SERVICE_STATE_CHANGED      = Messages.getString( "FMT_MSG_SERVICE_STATE_CHANGED" );      //$NON-NLS-1$
  String FMT_MSG_LISTENER_STATE_CHANGED     = Messages.getString( "FMT_MSG_LISTENER_STATE_CHANGED" );     //$NON-NLS-1$
   ...
   */
  String FMT_ERR_CMD_GWID_IS_INVALID      = Messages.getString( "FMT_ERR_CMD_GWID_IS_INVALID" );      //$NON-NLS-1$
  ...
  String FMT_ERR_CMD_NO_MANDATORY_ARG     = Messages.getString( "FMT_ERR_CMD_NO_MANDATORY_ARG" );     //$NON-NLS-1$
  String FMT_ERR_CMD_ARG_INV_ATOMIC_TYPE  = Messages.getString( "FMT_ERR_CMD_ARG_INV_ATOMIC_TYPE" );  //$NON-NLS-1$
  ...
  String FMT_ERR_UNEXPECTED_TESTING       = Messages.getString( "FMT_ERR_UNEXPECTED_TESTING" );       //$NON-NLS-1$
  ...
  String FMT_ERR_CLASS_DUP_SELF_PROP_ID    = Messages.getString( "FMT_ERR_CLASS_DUP_SELF_PROP_ID" );    //$NON-NLS-1$
  String FMT_ERR_CLASS_DUP_SUPER_PROP_ID   = Messages.getString( "FMT_ERR_CLASS_DUP_SUPER_PROP_ID" );   //$NON-NLS-1$
  String FMT_ERR_CLASS_DUP_SUB_PROP_ID     = Messages.getString( "FMT_ERR_CLASS_DUP_SUB_PROP_ID" );     //$NON-NLS-1$
   ...
   * {@link SkWorkerBase}
   */
  String FMT_INFO_DOJOB_STAT        = Messages.getString( "FMT_INFO_DOJOB_STAT" );        //$NON-NLS-1$
  String FMT_INFO_CURRDATA_RECEVIED = Messages.getString( "FMT_INFO_CURRDATA_RECEVIED" ); //$NON-NLS-1$

  /**
   * AbstractDtoObjectManager
   */
  String ERR_OBJ_ALREADY_REMOVED = Messages.getString( "ERR_OBJ_ALREADY_REMOVED" ); //$NON-NLS-1$
  String ERR_OBJ_ALREADY_EXIST   = Messages.getString( "ERR_OBJ_ALREADY_EXIST" );   //$NON-NLS-1$
  String ERR_OBJ_NOT_FOUND       = Messages.getString( "ERR_OBJ_NOT_FOUND" );       //$NON-NLS-1$
