 ...
 * @author hazard157
 */
public final class SkQueryFilterByEventParam
    implements ITsFilter<SkEvent> {

  /**
   * Идентификатор типа фильтра {@link ITsSingleFilterFactory#id()},
   */
  public static final String TYPE_ID = STD_FILTERID_ID_PREFIX + ".EventParam"; //$NON-NLS-1$
  ...
  public static final ITsSingleFilterFactory<SkEvent> FACTORY =
      new AbstractTsSingleFilterFactory<>( TYPE_ID, SkEvent.class ) {
        ...
        protected ITsFilter<SkEvent> doCreateFilter( IOptionSet aParams ) {
          ...
          return new SkQueryFilterByEventParam( paramId, op, constant );
        }
      };
   ...
   */
  public SkQueryFilterByEventParam( String aParamId, EAvCompareOp aOp, IAtomicValue aConst ) {
